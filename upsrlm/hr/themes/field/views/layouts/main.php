    ...
    <body class="no-skin" ng-app="questionnaireApp">
        ...
        <div class="top-head">
            ...
            <div class="row">  
                ...
                <div class="col-lg-2">
                    <h2 style="color: #F79520;"> HR Portal</h2>
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="" style="background-color:#333444" id="right-nav-buttons-inner">
                        <ul class="nav ace-nav " id="main-nav-bar-ul">
                            ...
                            <?php if (!Yii::$app->user->isGuest) { ?>
                                ...
                                <?php if (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_HR_ADMIN, MasterRole::ROLE_JMD])) { ?>
                                    <li class="blue">
                                        <a  class="dropdown-toggles" href="/user/bmmu">
                                            <i class="ace-icon fa fa-user"></i>
                                            <span class="">BMMU</span>
                                        </a>  
                                    </li>
                                    <li class="blue">
                                        <a  class="dropdown-toggles" href="/user/dmmu">
                                            <i class="ace-icon fa fa-user"></i>
                                            <span class="">DMMU</span>
                                        </a>  
                                    </li>
                                    <li class="blue">
                                        <a  class="dropdown-toggles" href="/user/smmu">
                                            <i class="ace-icon fa fa-user"></i>
                            ...
                            <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_BMMU]))) { ?>
                                <li class="blue">  
                                    <a  data-toggle="dropdown" class="dropdown-toggle "  href="#">
                                        <i class="mdi mdi-view-list"></i> <span>BMMU Profile</span> 
                                    ...
                                    <ul class="user-menu dropdown-menu-right dropdown-navbar navbar-grey dropdown-menu dropdown-caret dropdown-close">
                                        <li class="dropdown-header">
                                            <a href="/profile/update" style="padding-left: 10px;"><i class="fa fa-user"></i><span> Update Your Profile </span> </a>
                                        </li>
                            ...
                            <?php } else { ?>
                                <li class="blue">  
                                    <a  data-toggle="dropdown" class="dropdown-toggle "  href="#">
                                        <i class="mdi mdi-view-list"></i> <span>Profile</span> 
                                        <i class="ace-icon fa fa-caret-down"></i>
                                    </a>
                                    <ul class="user-menu dropdown-menu-right dropdown-navbar navbar-grey dropdown-menu dropdown-caret dropdown-close">
                                        <?php if (Yii::$app->user->identity->profile_status == 0) { ?>
                                            <li class="dropdown-header">
                                                <a href="/profile/update" style="padding-left: 10px;"><i class="fa fa-user"></i><span> Update Your Profile </span> </a>
                                            </li>
                                        <?php } ?>
                                        <?php if (Yii::$app->user->identity->profile_status == 1) { ?>    
                                            <li class="dropdown-header">
                                                <a href="/profile/view" style="padding-left: 10px;"><i class="fa fa-user"></i><span> View Your Profile </span> </a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </li>  
