...
$this->title = "Bank/FI's Registration";
...
<div class='profile-form' style="padding:0px 10px;background-color: white">
    ...
    <div class='box bordered-box orange-border grey-background' style="padding:10px;margin:20px;background-color: #bbbbbb">       
        ...
        <div class='box-content box-status'>
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'name_of_organization') ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'inst_email') ?>

                </div>
                <div class="col-md-6">
                    <?= $form->field($model, 'hq_email') ?>
    ...
    <div class='box bordered-box orange-border grey-background' style="padding:10px;margin:20px;background-color: #bbbbbb">       
        ...
        <div class='box-content box-status'>
            <div class="row">
                <div class="col-md-4">
                    <?= $form->field($model, 'signatory_first_name') ?>
                </div>
                <div class="col-md-4">
                    <?= $form->field($model, 'signatory_middle_name') ?>  
                </div>
                <div class="col-md-4">
                    <?= $form->field($model, 'signatory_sur_name') ?>   
                </div>
            </div>
        </div>
    </div>
    ...
    <div class='box bordered-box orange-border grey-background' style="padding:10px;margin:20px;background-color: #bbbbbb">       
        ...
        <div class='box-content box-status'>
            <div class="row">
                <div class="col-md-4">
                    <?= $form->field($model, 'signatory_primary_phone_no') ?>  
                </div>
                <div class="col-md-4">
                    <?= $form->field($model, 'signatory_alternate_phone_no') ?>
                </div>
                <div class="col-md-4">
                    <?= $form->field($model, 'signatory_whatsapp_no') ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class='box bordered-box orange-border grey-background' style="padding:10px;margin:20px;background-color: #bbbbbb">       
        ...
        <div class='box-content box-status'>
            <div class="row">
                ...
                <div class="col-md-6">
                    <?= $form->field($model, 'signatory_designation') ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'signatory_inst_email') ?>

                </div>
                <div class="col-md-6">
                    <?= $form->field($model, 'signatory_hq_email') ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'signatory_office_phone_no') ?>

                </div>
                <div class="col-md-6">
                    <?= $form->field($model, 'signatory_hq_phone_no') ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <?= $form->field($model, 'signatory_office_address') ?>
                </div> 
                <div class="col-md-6">
                    <?= $form->field($model, 'signatory_hq_address') ?>
                </div> 
            </div>
        </div>
    </div>
