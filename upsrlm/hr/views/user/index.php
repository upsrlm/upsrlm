        ...
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    <?php if (isset(Yii::$app->user->identity->role) and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_HR_ADMIN, MasterRole::ROLE_JMD])) { ?>
...
//                        'contentOptions' => ['style' => 'width: 10%'],
                            ...
                            [
                                'attribute' => 'Action',
                                'format' => 'raw',
                                'visible' => isset(Yii::$app->user->identity->role) and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_HR_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_JMD]),
                                'value' => function ($model) {
                                    $html = '';
                                    ...
                                    if ($model->role == MasterRole::ROLE_BMMU) {
                                        $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/updatebmmu', 'userid' => $model->id], [
                                                    'title' => 'Update User',
                                                    'data-pjax' => "0",
                                                    'class' => 'btn btn-sm btn-info',
                                                ]) . ' ';
                                    } elseif ($model->role == MasterRole::ROLE_DMMU) {
                                        $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/updatedmmu', 'userid' => $model->id], [
                                                    'title' => 'Update User',
                                                    'data-pjax' => "0",
                                                    'class' => 'btn btn-sm btn-info',
                                                ]) . ' ';
                                    } elseif (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_HR_ADMIN])) {
                                    ...
                                    if ($model->role != MasterRole::ROLE_CBO_USER and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_HR_ADMIN])) {
                                    ...
                                    if (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_HR_ADMIN])) {
                                    ...
                                    if ($model->status == User::STATUS_INACTIVE and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_HR_ADMIN])) {
                                    ...
                                    if ($model->status == User::STATUS_ACTIVE and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_HR_ADMIN])) {
