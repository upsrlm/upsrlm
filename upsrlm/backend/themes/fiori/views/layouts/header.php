<div class="dashboard_header_primary">
    <div class="container-fluid">
        <div class="row no-gutters">
            <div class="col-md-4">
                <div class="dashboard_nav_left d-flex justify-content-start">
                    <div class="dashboard_logo_left">
                        <a href="index.html"><img src="assets/images/logo_up.png" class="img-fluid" alt=""></a>
                    </div>
                    <div class="dashboard_logo_text">
                        <h3>Uttar Pradesh State</h3>
                        <h2>Rural Livehood Mission </h2>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="dashboard_nav_right d-flex justify-content-start">
                    <div class="dashboard_logo_right">
                        <h3>Department of</h3>
                        <h3>Rural Development </h3>
                        <h4>Goverment Of Uttar pradesh</h4>

                    </div>
                    <div class="dashboard_primary_logo">
...
<div class="app-header header-shadow bg-plum-plate header-text-light">
    <div class="container-fluid fiori-container">
        ...
        <div class="app-header-right">
                ...
                <div class="widget-content">
                    <div class="widget-content-wrapper">
                        <div class="widget-content-left">
                            <div class="dropdown">
                                <button type="button" class="btn custom_drop_btn dropdown-toggle" data-toggle="dropdown">
                                    Select Portal
                                    <i class="nav-icon-pointer icon ion-ios-arrow-down"></i>
                                </button>
            ...
            <div class="header-btn-lg" style="visibility:hidden">
            </div>
            <div class="user_logout">
                <div class="dropdown">

                    <button type="button" class="btn custom_drop_btn dropdown-toggle" data-toggle="dropdown">
                       <!-- <i class="fa fa-lock logout_icon"></i>-->
                        Welcome 
                        <i class="nav-icon-pointer icon ion-ios-arrow-down"></i>
                    </button>
