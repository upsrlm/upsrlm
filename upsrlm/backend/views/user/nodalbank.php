...
//                        'contentOptions' => ['style' => 'width: 20%'],
                                ...
                                'value' => function ($model) {
                                    $html = '';
                                    if (in_array($model->role, [MasterRole::ROLE_RSETIS_NODAL_BANK])) {
...
//                        'contentOptions' => ['style' => 'width: 18%'],
                                'value' => function ($model) {
                                    ...
                                    if ($model->role == MasterRole::ROLE_RSETIS_NODAL_BANK) {
                                        $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/updatenodalbank', 'userid' => $model->id], [
