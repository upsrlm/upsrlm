                        ...
                        DetailView::widget([
                            ...
                            'attributes' => [
                                [
                                  ...
                                  <img width="220px" src="" data-src="' . Yii::$app->params['app_url']['hr'] .$model->getImageUrl("photo_profile") . '" class="lozad" title="Profile Photo" style="cursor : pointer"/> 
                                  </span>' : '',
                                ],
                            ],
                        ])
                        ...
                        DetailView::widget([
                            ...
                            'attributes' => [
                                [
                                  ...
                                  <img width="220px" src="" data-src="' .Yii::$app->params['app_url']['hr'] . $model->getImageUrl("photo_aadhaar_front") . '" class="lozad" title="" style="cursor : pointer"/> 
                                  </span>' : '',
                                ],
                            ],
                        ])
                        ...
                        DetailView::widget([
                            ...
                            'attributes' => [
                                [
                                  ...
                                  <img width="220px" src="" data-src="' .Yii::$app->params['app_url']['hr'] . $model->getImageUrl("photo_aadhaar_back") . '" class="lozad" title="Profile Photo" style="cursor : pointer"/> 
                                  </span>' : '',
                                ],
                            ],
                        ])
                        ...
                        DetailView::widget([
                            ...
                            'attributes' => [
                                [
                                  ...
                                  <img width="220px" src="" data-src="' . Yii::$app->params['app_url']['hr'] .$model->getImageUrl("photo_pan") . '" class="lozad" title="Profile Photo" style="cursor : pointer"/> 
                                  </span>' : '',
                                ],
                            ],
                        ])
                        ...
                        <div class="col-md-6">
                            ...
                            DetailView::widget([
                                ...
                                'attributes' => [
                                  ...
                                  <img width="220px" src="" data-src="' .Yii::$app->params['app_url']['hr'] . $model->getImageUrl("photo_letter_of_appointment") . '" class="lozad" title="Profile Photo" style="cursor : pointer"/> 
                                  </span>' : '',
                                    ],
                                ],
                            ])
                            ...
                            DetailView::widget([
                                ...
                                'attributes' => [
                                  ...
                                  <img width="220px" src="" data-src="' . Yii::$app->params['app_url']['hr'] .$model->getImageUrl("photo_service_agreement") . '" class="lozad" title="Profile Photo" style="cursor : pointer"/> 
                                  </span>' : '',
                                    ],
                                ],
                            ])
                            ...
                            DetailView::widget([
                                ...
                                'attributes' => [
                                  ...
                                  <img width="220px" src="" data-src="' . Yii::$app->params['app_url']['hr'] .$model->getImageUrl("photo_letter_of_last_posting_order") . '" class="lozad" title="Profile Photo" style="cursor : pointer"/> 
                                  </span>' : '',
                                    ],
                                ],
                            ])
                        ...
                        <div class="col-md-6">
                            ...
                            DetailView::widget([
                                ...
                                'attributes' => [
                                  ...
                                  <img width="220px" src="" data-src="' . Yii::$app->params['app_url']['hr'] .$model->getImageUrl("photo_bank_passbook") . '" class="lozad" title="Profile Photo" style="cursor : pointer"/> 
                                  </span>' : '',
                                    ],
                                ],
                            ])
