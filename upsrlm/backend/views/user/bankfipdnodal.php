...
$this->title = 'Bank/FI Partner District Nodal';
        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <?php echo $this->render('_searchbankfinodal', ['model' => $searchModel]); ?>
...
//                        'contentOptions' => ['style' => 'width: 18%'],
                                'value' => function ($model) {
                                    ...
                                    $html .= Html::a('<i class="fal fa fa-eye"></i>', ['/user/view', 'userid' => $model->id], [
                                                'title' => 'View Bank/FI Partner District Nodal',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info mb-2',
                                            ]) . ' ';
                                    $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/updatebankfipdnodal', 'userid' => $model->id], [
                                                'title' => 'Update Bank/FI Partner District Nodal User',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info mb-2',
                                            ]) . ' ';
