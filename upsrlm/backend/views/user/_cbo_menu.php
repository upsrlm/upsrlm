    ...
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            ...
            <ul class="nav nav-tabs small justify-content-center" style="margin-top:10px;">
                ...
                <li class="active"><a class="btn btn-info" data-toggle="tab" href="#dhtab">JSON Format</a></li>
                <li><a class="btn btn-info" data-toggle="tab" href="#phctab">Raw Format</a></li>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> 
                                            ...
                                            <script>
                                                datas = <?php echo $model->menu_json; ?>;
                                            </script>    
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="word-break: break-all;"> 
                                            <?php
                                            echo "<pre>";
                                            echo json_encode(json_decode($model->menu_json), JSON_PRETTY_PRINT);
                                            echo "</pre>";
                                            ?>
