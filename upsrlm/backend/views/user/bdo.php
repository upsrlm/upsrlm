...
$this->title = 'Block Development Officer';
        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <?php echo $this->render('_searchbdo', ['model' => $searchModel]); ?>
...
//                        'contentOptions' => ['style' => 'width: 12%'],
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    $html = '';
                                    if (in_array($model->role, [MasterRole::ROLE_BDO])) {
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    $html = '';
                                    if (in_array($model->role, [MasterRole::ROLE_BDO])) {
                                        $html .= implode(', ', array_unique(ArrayHelper::getColumn($model->blocks, 'district.district_code')));
                                    }
                                    return $html;
                                },
                            ],
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    if (in_array($model->role, [MasterRole::ROLE_BDO])) {
                                        ...
                                        $html .= '' . implode(', ', array_unique(ArrayHelper::getColumn($model->blocks, 'block.block_code')));
                                    }
                                    return $html;
                                },
                            ],            
...
//                        'contentOptions' => ['style' => 'width: 18%'],
                                'value' => function ($model) {
                                    ...
                                    $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/updatebdo', 'userid' => $model->id], [
                                                'title' => 'Update BDO User',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info',
                                            ]) . ' ';
