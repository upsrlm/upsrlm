...
$this->title = 'RSETI Batch creator';
...
//                        'contentOptions' => ['style' => 'width: 20%'],
                                ...
                                'value' => function ($model) {
                                    ...
                                    } elseif (in_array($model->role, [MasterRole::ROLE_RSETIS_BATCH_CREATOR])) {
                                        $html .= implode(', ', array_unique(ArrayHelper::getColumn($model->districts, 'district.district_name')));
                                    }  else {
...
//                        'contentOptions' => ['style' => 'width: 18%'],
                                'value' => function ($model) {
                                    ...
                                    $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/updatersethibacthcreator', 'userid' => $model->id], [
                                                'title' => 'Update Rsethi Batch Creator User',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info mb-2',
                                            ]) . ' ';
