...
} else if ($model->role == MasterRole::ROLE_CBO_USER) {
    $this->params['breadcrumbs'][] = ['label' => 'CBO User', 'url' => ['cbo']];
} else {
    ...
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    ...
                    if ($model->role == MasterRole::ROLE_CBO_USER) {
                        echo Html::a('<span class="fal fa fa-exchange"></span> Reset Menu', ['/user/resetmenu', 'userid' => $model->id], [
                            'title' => 'Reset Rishta App Menu',
                            'data-pjax' => "0",
                            'class' => 'btn btn-sm btn-info',
                            'data-confirm' => 'Are you sure you want to reset rishta app menu of this user?',
                            'data-method' => 'POST',
                        ]) . ' ';
                    }
                    ?>
            ...
            <div class="panel-container show">
                ...
                if ($model->role == MasterRole::ROLE_CBO_USER) {
                    if (isset($model->cbomenu)) {
                        echo $this->render('_cbo_menu', ['model' => $model->cbomenu]);
                    }
                }
                ?>  
            </div>      
