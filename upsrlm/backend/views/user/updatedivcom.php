...
$this->title = 'Update Divisional Commissioner';
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-4 mb-3">
                            <?php
                            echo $form->field($model, 'division_code')->widget(kartik\select2\Select2::classname(), [
                                'data' => $model->division_option,
                                'size' => Select2::MEDIUM,
                                'options' => ['placeholder' => 'Select Division', 'multiple' => TRUE],
                                'pluginOptions' => [
                                    'allowClear' => true
                                ],
                            ]);
