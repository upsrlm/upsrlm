...
//                        'contentOptions' => ['style' => 'width: 18%'],
                                'value' => function ($model) {
                                    ...
                                    $html .= Html::a('<i class="fal fa fa-eye"></i>', ['/user/view', 'userid' => $model->id], [
                                                'title' => 'Update DM User',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info mb-2',
                                            ]) . ' ';
                                    if ($model->role == MasterRole::ROLE_RSETIS_DISTRICT_UNIT) {
                                        $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/updatersethisdu', 'userid' => $model->id], [
                                                    'title' => 'RSETIs District Unit',
                                                    'data-pjax' => "0",
                                                    'class' => 'btn btn-sm btn-info mb-2',
                                                ]) . ' ';
                                    }
                                    if ($model->role == MasterRole::ROLE_RSETIS_STATE_UNIT) {
                                        $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/update', 'userid' => $model->id], [
                                                    'title' => 'RSETIs State Unit',
                                                    'data-pjax' => "0",
                                                    'class' => 'btn btn-sm btn-info mb-2',
                                                ]) . ' ';
                                    }
                                    ...
                                    $html .= Html::a('<span class="fas fa fa-sign-in"></span>', ['/user/changeloginmethod', 'userid' => $model->id], [
