...
//                        'contentOptions' => ['style' => 'width: 20%'],
                                ...
                                'value' => function ($model) {
                                    $html = '';
                                    if (in_array($model->role, [MasterRole::ROLE_BANK_DISTRICT_UNIT])) {
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    $html .= Html::a('<i class="fal fa fa-eye"></i>', ['/user/view', 'userid' => $model->id], [
                                                'title' => 'View Bank/FI Partner User',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info mb-2',
                                            ]) . ' ';
                                    $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/updatebankdu', 'userid' => $model->id], [
                                                'title' => 'Update Bank/FI Partner User',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info mb-2',
                                            ]) . ' ';
