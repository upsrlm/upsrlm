...
$this->title = 'Chief Development Officer';
...
//                        'contentOptions' => ['style' => 'width: 20%'],
                                ...
                                'value' => function ($model) {
                                    $html = '';
                                    if (in_array($model->role, [MasterRole::ROLE_CDO])) {
...
//                        'contentOptions' => ['style' => 'width: 18%'],
                                'value' => function ($model) {
                                    ...
                                    $html .= Html::a('<i class="fal fa fa-eye"></i>', ['/user/view', 'userid' => $model->id], [
                                                'title' => 'View Chief Development Officer User',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info',
                                            ]) . ' ';
                                    $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/updatecdo', 'userid' => $model->id], [
                                                'title' => 'Update Chief Development Officer User',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info',
                                            ]) . ' ';
