...
$this->title = 'Divisional Commissioner';
        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <?php echo $this->render('_searchdc', ['model' => $searchModel]); ?>
...
//                        'contentOptions' => ['style' => 'width: 18%'],
                                'value' => function ($model) {
                                    ...
                                    $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/updatedc', 'userid' => $model->id], [
                                                'title' => 'Update Divisional Commissioner User',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info mb-2',
                                            ]) . ' ';
