...
//                        'contentOptions' => ['style' => 'width: 20%'],
                                ...
                                'value' => function ($model) {
                                    $html = '';
                                    if (in_array($model->role, [MasterRole::ROLE_DC_NRLM])) {
...
//                        'contentOptions' => ['style' => 'width: 18%'],
                                'value' => function ($model) {
                                    ...
                                    $html .= Html::a('<i class="fal fa fa-eye"></i>', ['/user/view', 'userid' => $model->id], [
                                                'title' => 'View DC NRLM User',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info  mb-2',
                                            ]) . ' ';
                                    $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/user/updatedcnrlm', 'userid' => $model->id], [
                                                'title' => 'Update DC NRLM User',
                                                'data-pjax' => "0",
                                                'class' => 'btn btn-sm btn-info  mb-2',
                                            ]) . ' ';
