                    ...
                    GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return $model->apicallstatus != null ? $model->apicallstatus->id . ' : ' . $model->apicallstatus->call_status_ctc : '';
                                }
                            ],
                            [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    return $model->recording_file != null ? Html::button('<span class="fal fa-file-audio">Audio</span>', [
                                        ...
                                        'value' => '/cloudtel/log/telecalleraudio?log_id=' . $model->id. '&date=' . date('Y-m-d', $model->created_at),
                                        'title' => 'Audio'
                                    ]) . ' ' : '';
                                }
                            ],
