            ...
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    <?php if (isset(Yii::$app->user->identity) and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN])) { ?>
                        ...
                        <?= Html::a('Add Notice', ['create'], ['class' => 'btn btn-success']) ?>
...
//                'floatHeaderOptions' => ['scrollingTop' => '50'],
                        'columns' => [
                            ...
                            [
                                ...
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return $model->file != null ? Html::a('<span class="fal fa-download"> Download</span>', Yii::$app->params['app_url']['www'] . '/uploads/notice/' . $model->file, [
                                        'target' => '_blank',
                                        'data-pjax' => "0",
                            ...
                            [
                                ...
                                'buttons' => [
                                    'update' => function ($url, $model) {
                                        return Html::a('<span class="fal fa-pencil"></span>', ['update?noticeid=' . $model->id], [
                                            'class' => '',
                                            'data-pjax' => "0",
                                            'class' => 'btn btn-sm btn-primary',
                                        ]);
                                    ...
                                    'view' => function ($url, $model) {
                                        return ' ' . Html::a('<span class="fal fa-eye"></span>', ['view?noticeid=' . $model->id], [
                                            'class' => '',
                                            'data-pjax' => "0",
                                            'class' => 'btn btn-sm btn-primary',
                                        ]);
