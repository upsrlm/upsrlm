    ...
    <div class="row">
        ...
        <div class="col-xl-2 col-md-4 mb-2">
            ...
            echo $form->field($model, 'master_partner_bank_id')->widget(Select2::classname(), [
                ...
                'options' => ['placeholder' => 'Current Partner Bank', 'style' => 'width:250px'],
                'pluginOptions' => [
                    'allowClear' => true
                ],
            ]);
        ...
        <div class="col-xl-2 col-md-4 mb-2">
            <?php
            echo $form->field($model, 'previous_master_partner_bank_id')->widget(Select2::classname(), [
                'data' => $model->bank_option,
                'options' => ['placeholder' => 'Previous Partner Bank', 'style' => 'width:250px'],
                'pluginOptions' => [
                    'allowClear' => true
                ],
            ]);
