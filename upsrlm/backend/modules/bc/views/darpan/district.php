...
<div class="row">
    <div class="col-xl-12">
                        ...
                        'afterHeader' => true ? [
                            [
                                'columns' => [
                                    ...
                                    ['content' => 'Total', 'options' => ['colspan' => 3, 'class' => 'font-weight-bold bg-warning-100 text-right']],
                                    ['content' => $searchModeld->getTotaltc().' '.$searchModeld->getTcontc(), 'options' => ['colspan' => 1, 'class' => 'font-weight-bold bg-warning-100']],
                                    ['content' => $searchModeld->getTotaloperational().' '.$searchModeld->getTconop(), 'options' => ['colspan' => 1, 'class' => 'font-weight-bold bg-warning-100']],
                                ],
                            ]
                                ] : '',
                        'columns' => [
                            ...
                            [
                                    ...
                                    'format' => 'raw',
                                    'value' => function ($model) {
                                        return Html::a($model->district_name, ['/bc/darpan/block?district_code=' . $model->district_code.'&date='.$model->date], [
                                            'data-pjax' => "0",
        ...
        $("#searchbtn").click(function(event){
                $("#Searchform").attr({ "action":"/bc/darpan/district"});
