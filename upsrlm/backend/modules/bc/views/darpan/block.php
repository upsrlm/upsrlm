        ...
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
               ...
               <div class="panel-toolbar">
                   ...
                   <a href="/bc/darpan/district?BcGovermentReportBlockSearch[date]=<?=$searchModel->date?>" data-pjax="0" class="btn btn-primary"> Back </a>
                </div> 
            </div>
...
//                    ]);
                    ...
                    GridView::widget([
                        ...
                        'afterHeader' => true ? [
                                [
                                    'columns' => [
                                        ['content' => '0', 'options' => ['colspan' => 1, 'class' => 'font-weight-bold bg-warning-100']],
                                        ['content' => 'Total', 'options' => ['colspan' => 4, 'class' => 'font-weight-bold bg-warning-100 text-right']],
                                        ['content' => $searchModel->getTotaltc().' '.$searchModel->getTcontc(), 'options' => ['colspan' => 1, 'class' => 'font-weight-bold bg-warning-100']],
                                        ['content' => $searchModel->getTotaloperational().' '.$searchModel->getTconop(), 'options' => ['colspan' => 1, 'class' => 'font-weight-bold bg-warning-100']],
                                       
                                    ],
                                ]
                                    ] : '',
                        'columns' => [
                            ['class' => 'yii\grid\SerialColumn', 'header' => 'Srl.No.','contentOptions' => ['width' => '4px']],
                            [
                                'attribute' => 'state_name',
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return isset($model->state_name) ? $model->state_name : '';
                                }
                            ],
                            [
                                ...
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return isset($model->div->lgd_division_name) ? $model->div->lgd_division_name : '';
                                }
                            ],        
                            [
                           ...
                           [
                                ...
                                'format' => 'raw',
                                'value' => function ($model) {
                                    return isset($model->trained_and_certified) ? $model->trained_and_certified.' '.$model->iconts : '';
                                }
                            ],
                            [
                                ...
                                'format' => 'raw',
                                'value' => function ($model) {
                                    return isset($model->operational) ? $model->operational.' '.$model->iconop : '';
                                }
                            ],
        ...
        $("#searchbtn").click(function(event){
                $("#Searchform").attr({ "action":"/bc/darpan/block"});
