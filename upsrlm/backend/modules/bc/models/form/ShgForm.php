...
namespace backend\modules\bc\models\form;
...
class ShgForm extends \yii\base\Model {
    ...
    public function __construct($bc_application_model) {
        $this->bc_application_model = $bc_application_model;
        $this->block_option = GenralModel::blockopption($this);
        $this->district_option = GenralModel::nfsaoptiondistrict($this);
        $this->gp_option = ArrayHelper::map(\common\models\master\MasterGramPanchayat::find()->where(['gram_panchayat_code' => $this->bc_application_model->gram_panchayat_code])->all(), 'gram_panchayat_code', 'gram_panchayat_name');
    ...
    public function rules() {
        return [
            ...
            [['chaire_person_mobile_no', 'treasurer_mobile_no', 'secretary_mobile_no'], \common\validators\MobileNoValidator::class],
