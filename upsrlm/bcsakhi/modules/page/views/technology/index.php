    ...
    <div class="container-fluid px-3 px-lg-5 py-4">
        <div class="row mb-4 align-items-center">
            <div class="col-lg-7">
                ...
                <div class="app-store-btns">
                    <a class="google" href="https://play.google.com/store/apps/details?id=com.up.srlm.bcselection&hl=en_IN&gl=US" target="_blank">Google Play </a>
                </div>
            </div>
            <div class="col-lg-5">
                <div class="right_img">
        ...
        <div class="row my-2 align-items-center">
            ...
            <div class="col-lg-7 order-lg-2 order-1">
                ...
                <div class="app-store-btns">
                    <a class="google" href="https://play.google.com/store/apps/details?id=com.triline.upsrlm.rishta" target="_blank">Google Play </a>
                </div>
            </div>
