    ...
    <div class="col-xl-12 p-0">
        <div id="panel-1" class="panel">
            ...
            <div class='panel-body mt-2 label-set'>
                ...
                <div class='card px-2'>
                    <div class="col-lg-12">
                        <?= $form->field($model, 'machine_work')->radioList([1 => 'हाँ', 2 => 'नहीं'], ['separator' => '']); ?>
                    </div>
                </div>
                <div class='card px-2'>
                    <div class="col-lg-12">
                        <?= $form->field($model, 'machine_problem')->checkboxList($model->machine_problem_option, ['separator' => '']); ?>
                ...
                <div class='card px-2'>
                    <div class="col-lg-12">
                        ...
                        <?=
                        $form->field($model, 'machine_problem_99_text', [
                        ])->textInput(['maxlength' => true, 'placeholder' => 'कोई अन्य समस्या'])
                        ?>
                    </div>
                </div>
