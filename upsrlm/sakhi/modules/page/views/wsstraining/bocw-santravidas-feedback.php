...
$this->title = 'संत रविदास शिक्षा प्रोत्साहन योजनाा पर प्रतिक्रिया';
$app = new \sakhi\components\App();
$option = ['separator' => '<br/>'];
if (isset($model->feedback_model->id)) {
    $option = ['separator' => '<br/>','itemOptions' =>['disabled' => true]];
}
?>
<div class="card">
    <div class="col-lg-12">
...
$js = <<<JS
    $(document).ready(function() {
        $(".field-dbtschemebocwsantravidasfeedbackform-ques5").css("display","none");
  
         if($('input[type=radio][name="DbtSchemeBocwSantravidasFeedbackForm[ques4]"]:checked').val()=='1'){
              $(".field-dbtschemebocwsantravidasfeedbackform-ques5").css("display","none");
        }  

         if($('input[type=radio][name="DbtSchemeBocwSantravidasFeedbackForm[ques4]"]:checked').val()=='2'){
            $(".field-dbtschemebocwsantravidasfeedbackform-ques5").css("display","block");
        }

        $('input[type=radio][name="DbtSchemeBocwSantravidasFeedbackForm[ques4]"]').change(function() {
            if($(this).val() =='1'){
                $(".field-dbtschemebocwsantravidasfeedbackform-ques5").css("display","none");
            }else{ 
               $(".field-dbtschemebocwsantravidasfeedbackform-ques5").css("display","block");
