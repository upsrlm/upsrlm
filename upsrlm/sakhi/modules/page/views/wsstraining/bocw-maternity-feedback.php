...
$this->title = 'मातृत्व, शिशु एवं बालिका मदद योजना पर प्रतिक्रिया';
...
$js = <<<JS
    $(document).ready(function() {
        $(".field-dbtschemebocwmaternityfeedbackform-ques5").css("display","none");
  
         if($('input[type=radio][name="DbtSchemeBocwMaternityFeedbackForm[ques4]"]:checked').val()=='1'){
              $(".field-dbtschemebocwmaternityfeedbackform-ques5").css("display","none");
        }  

         if($('input[type=radio][name="DbtSchemeBocwMaternityFeedbackForm[ques4]"]:checked').val()=='2'){
            $(".field-dbtschemebocwmaternityfeedbackform-ques5").css("display","block");
        }

        $('input[type=radio][name="DbtSchemeBocwMaternityFeedbackForm[ques4]"]').change(function() {
            if($(this).val() =='1'){
                $(".field-dbtschemebocwmaternityfeedbackform-ques5").css("display","none");
            }else{ 
               $(".field-dbtschemebocwmaternityfeedbackform-ques5").css("display","block");
