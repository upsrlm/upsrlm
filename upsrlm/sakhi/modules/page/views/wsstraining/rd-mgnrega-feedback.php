...
$this->title = 'मनरेगा पर प्रतिक्रिया';
...
$js = <<<JS
    $(document).ready(function() {
        $(".field-dbtschememgnreafeedbackform-ques5").css("display","none");
  
         if($('input[type=radio][name="DbtSchemeMgnreaFeedbackForm[ques4]"]:checked').val()=='1'){
              $(".field-dbtschememgnreafeedbackform-ques5").css("display","none");
        }  

         if($('input[type=radio][name="DbtSchemeMgnreaFeedbackForm[ques4]"]:checked').val()=='2'){
            $(".field-dbtschememgnreafeedbackform-ques5").css("display","none");
        }

        $('input[type=radio][name="DbtSchemeMgnreaFeedbackForm[ques4]"]').change(function() {
            if($(this).val() =='1'){
                $(".field-dbtschememgnreafeedbackform-ques5").css("display","none");
            }else{ 
               $(".field-dbtschememgnreafeedbackform-ques5").css("display","block");
            }
        })
    });
JS;
