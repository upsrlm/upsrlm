        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <?php echo $form->field($model, "cbo_vo_id")->label("विलेज आर्गेनाइजेशन (ग्राम संगठन) को चुने")->dropDownList($model->vo_option, ['prompt' => "विलेज आर्गेनाइजेशन (ग्राम संगठन) को चुने"]) ?> 
