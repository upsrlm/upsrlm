...
?>
<div>
    <h1 >क्लस्टर-स्तरीय संकुल द्वारा मोबाइल ऐप के उपयोगिता पर आँकलन प्रपत्र</h1>
            ...
            DetailView::widget([
                ...
                'attributes' => [
                    ...
                    [
                        'attribute' => '',
                        'format' => 'raw',
                        'visible' => isset(\Yii::$app->user->identity->role) and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_CBO_USER]),
                        'value' => function ($model) {

                            $html = '<span id="' . $model->id . '">';
                            $html .= "</span>";
                            $html .= Html::a('<span class="fal fa-edit"></span>', ['/clf/default/feedback?clfid=' . $model->cbo_clf_id], [
                                        'data-pjax' => "0",
