...
class ApplicationController extends Controller {
    ...
    public function beforeAction($action) {
        throw new \yii\web\UnauthorizedHttpException("यूनिसेफ़ प्रायोजित वादा समूह सखी (WSS) के चयन संबंधी रिश्ता मोबाइल को कुछ दिनों के लिए स्थगित की गई है । ऐसा उत्तर प्रदेश राज्य ग्रामीण आजीविका मिशन के निर्देश के अनुपालन में हुआ है ताकि चयनित WSS सखियों का रिकॉर्ड निश्चित तिथि में स्थिर किया जा सके । शीघ्र ही रिश्ता ऐप के पुनः संचालित होने की सूचना आपको रिश्ता-DBT कॉल सेंटर से प्राप्त होगी ।");
            ...
            if ($model->load(Yii::$app->request->post()) && $model->validate()) {
                if (isset($_REQUEST['SubmitRequest']) && $_REQUEST['SubmitRequest'] == "1") {
                    if ($model->scenario == 'section1') {
                        ...
                        if ($model->application_model->bank_account_no) {
                            $model->application_model->wada_bank = 1;
                        }
...
//                            $content = base64_decode(\Yii::$app->request->post()['ApplicationForm']['profile_photo']);
//                            $im = imagecreatefromstring($content);
//                            $image_name = 'profile_photo_' . uniqid() . '.jpg';
//                            $model->application_model->profile_photo = $image_name;
//                            if ($im !== false) {
...
//                            $content1 = base64_decode(\Yii::$app->request->post()['ApplicationForm']['aadhar_front_photo']);
//                            $im1 = imagecreatefromstring($content1);
//                            $image_name1 = 'aadhar_front_photo_' . uniqid() . '.jpg';
//                            $model->application_model->aadhar_front_photo = $image_name1;
//                            if ($im1 !== false) {
//                                header('Content-Type: image/jpeg');
...
//                            $content2 = base64_decode(\Yii::$app->request->post()['ApplicationForm']['aadhar_back_photo']);
//                            $im2 = imagecreatefromstring($content2);
//                            $image_name2 = 'aadhar_back_photo_' . uniqid() . '.jpg';
//                            $model->application_model->aadhar_back_photo = $image_name2;
//                            if ($im2 !== false) {
//                                header('Content-Type: image/jpeg');
...
//                            $content3 = base64_decode(\Yii::$app->request->post()['ApplicationForm']['pan_photo']);
//                            $im3 = imagecreatefromstring($content3);
//                            $image_name3 = 'pan_photo_' . uniqid() . '.jpg';
//                            $model->application_model->pan_photo = $image_name3;
//                            if ($im3 !== false) {
//                                header('Content-Type: image/jpeg');
...
//                            $content4 = base64_decode(\Yii::$app->request->post()['ApplicationForm']['passbook_photo']);
//                            $im4 = imagecreatefromstring($content4);
//                            $image_name4 = 'passbook_photo_' . uniqid() . '.jpg';
//                            $model->application_model->passbook_photo = $image_name4;
//                            if ($im4 !== false) {
//                                header('Content-Type: image/jpeg');
