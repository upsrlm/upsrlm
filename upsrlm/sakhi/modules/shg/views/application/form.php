...
$section_5_class = '';
$section_6_class = '';
$section_1_url = '/shg/application/form-section?shgid=' . $model->shg_model->id . '&section=1';
$section_2_url = '/shg/application/form-section?shgid=' . $model->shg_model->id . '&section=2';
$section_3_url = '/shg/application/form-section?shgid=' . $model->shg_model->id . '&section=3';
$section_4_url = '/shg/application/form-section?shgid=' . $model->shg_model->id . '&section=4';
$section_5_url = '/shg/application/form-section?shgid=' . $model->shg_model->id . '&section=5';
$section_6_url = '/shg/application/form-section?shgid=' . $model->shg_model->id . '&section=6';

$section_confirm_url = '/shg/application/view?shgid=' . $model->shg_model->id;
if ($model->application_model == null) {
    ...
    if ($model->application_model->form_number == null) {
        ...
        $section_1_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_3_class = 'disabled';
        $section_4_class = 'disabled';
        $section_5_class = 'disabled';
        $section_6_class = 'disabled';
        ...
        $section_1_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_2_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_4_class = 'disabled';
        $section_5_class = 'disabled';
        $section_6_class = 'disabled';
        ...
        $section_1_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_2_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_3_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_5_class = 'disabled';
        $section_6_class = 'disabled';
        ...
        $section_2_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_3_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_4_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_6_class = 'disabled';
        ...
        $section_3_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_4_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_5_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        ...
        $section_4_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_5_url = '/shg/application/view?shgid=' . $model->shg_model->id;
        $section_6_url = '/shg/application/view?shgid=' . $model->shg_model->id;
    }
}
?>
