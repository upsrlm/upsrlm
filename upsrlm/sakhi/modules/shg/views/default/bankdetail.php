...
<div class="subheader mb-2">
    ...
    <?php 
        if($model->shg_bank_detail_model->id){
            ...
            echo Html::a('<span class="fal fa-times"> </span>', ['/shg/default/removebank?shgid=' . $model->shg_bank_detail_model->cbo_shg_id . '&bankid=' . $model->shg_bank_detail_model->id], [
                'class' => '',
                'data-pjax' => "0",
        ...
        <div id="panel-1" class="panel">
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <?php $form = ActiveForm::begin(['id' => 'form-shgbankdetail', 'enableAjaxValidation' => true, 'enableClientValidation' => false, 'options' => ['enctype' => 'multipart/form-data']]); ?>  
                    <div class="row">
                        <div class="col-lg-6">
                            <?php echo $form->field($model, "bank_account_no_of_the_shg")->label('बैंक का खाता संख्या')->textInput() ?>
                        </div>

                        <div class="col-lg-6">
                            <?php echo $form->field($model, "bank_id")->dropDownList(\common\models\base\GenralModel::cbo_bank_option() ,['prompt' => 'चयन कीजिए'])->label('बैंक का नाम') ?>
                        </div> 
                        ...
                        <div class="col-lg-6">
                         ...
                         <div class="col-lg-6 mt-3">
                            <?php echo $form->field($model, "balance_as_on_date")->label('दिनांक के अनुसार शेष राशि')->textInput() ?>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <?php if(isset($model->shg_bank_detail_model->passbook_photo)){ ?>
                                <img src="/shg/default/bankpassbook?shgid=<?=$model->shg_bank_detail_model->cbo_shg_id?>&path=<?=$model->shg_bank_detail_model->passbook_photo?>" alt="<?=$model->shg_bank_detail_model->passbook_photo?>" class="img-responsive mb-2" width="100%" height="auto" >
                            <?php } ?>
                        </div>
                    </div>
