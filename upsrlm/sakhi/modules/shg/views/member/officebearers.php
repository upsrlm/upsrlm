...
$this->title = 'पदाधिकारीयों एवं सदस्यों का विवरण  ';
$role_option = $model->shg_member_office_bearers_model->shgrolelist();
$role_option = [4 => 'सदस्य'];
?>
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <?php $form = ActiveMobileForm::begin(['id' => 'form-shgmemberoffice', 'enableAjaxValidation' => true, 'enableClientValidation' => false, 'options' => ['enctype' => 'multipart/form-data']]); ?>  
                    <div class="row">
                        <div class="col-lg-6">
                            <?php echo $form->field($model, "role")->dropDownList($role_option, ['prompt' => 'चयन कीजिए'])->label('भूमिका') ?>
                        </div>  
                        ...
                        <div class="col-lg-6">
                            <?php echo $form->field($model, "no_of_relative")->label('अगर हाँ, तो कितने')->textInput(['type' => 'number', 'min' => 0]) ?>
                        </div>
                    </div>

                    <div class="form-group text-center">
                        <?= $form->field($model, 'cbo_shg_id')->hiddenInput()->label(false); ?>
                        <?= $form->field($model, 'cbo_shg_member_id')->hiddenInput()->label(false); ?>
