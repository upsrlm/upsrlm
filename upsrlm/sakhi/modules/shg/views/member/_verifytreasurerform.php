...
$this->title = 'कोषाध्यक्ष सत्यापित करें';
?>
<div class="row">
    <div class="col-xl-12">
                ...
                <div class="panel-content">
                            ...
                            echo DetailView::widget([
                                ...
                                'attributes' => [
                                    ...
                                    [
                                        ...
                                        'label' => 'कोषाध्यक्ष का नाम ',
                                        'value' => function ($model) {
                                            return $model->treasurer_name;
                                        },
                                    ],
                                    [
                                        'attribute' => 'treasurer_mobile_no',
                                        'label' => 'कोषाध्यक्ष मोबाइल नंबर ',
                                        'value' => function ($model) {
                                            return $model->treasurer_mobile_no;
                                        },
                                    ],
                                ],
                            ])
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php echo $form->field($model, 'verify_t_ques1')->radioList($model->yes_no_option)->label("समूह का नाम, पदाधिकारीयों के नाम व फ़ोन नम्बर सत्यापित करें"); ?> 
                            <?php echo $form->field($model, 'verify_t_ques2')->radioList($model->yes_no_option)->label("क्या आपके पास स्मार्ट्फ़ोन है?"); ?> 
                            <?php echo $form->field($model, 'verify_t_ques3')->radioList($model->yes_no_option)->label("अगर हाँ तो, क्या आप समूह सम्बन्धी मोबाइल ऐप अपने फ़ोन पर चलने के लिए सहमत हैं?"); ?> 
