...
<div class='card'>
    <div class="col-lg-12">
        ...
        <button type="button" class="btn btn-primary btn-sm mt-2" onClick="takePictureVoterid('imageDataVoterid')">
            <i class="fal fa-camera"></i> मतदाता पहचान पत्र फोटो अपलोड करें
        </button>
        <?= $form->field($model, 'voter_id_photo')->hiddenInput()->label('') ?>
        <img id="voter_id_photo-image" src="" class="img-responsive" width="200" height="300" />
        <?php if (isset($model->dbt_member_model->voter_id_photo)) { ?>
            <div class="col-lg-6">
                <img src="<?= $model->dbt_member_model->voterid_photo_url ?>" alt="<?= $model->dbt_member_model->voter_id_photo ?>" class="img-responsive mb-2" width="100%" height="auto">
            </div>
        <?php } ?>
