...
<div class="row">
    <div class="col-xl-12">
        ...
        <span class="input-group-text"><i class="fal fa-calendar-alt text-primary"></i> </span>
                            ...
                            ])->textInput(['placeholder' => 'गठन की तारीख', 'readonly' => 'readonly', 'onclick' => "javascript:return showCalender(date,mindate,maxdate,'rishtashgprofileform-date_of_formation');"])->label('गठन की तारीख')
                            ?>   
                        </div>
                    </div>
