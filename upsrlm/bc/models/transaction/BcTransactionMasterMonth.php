 ...
 * @property int $status
 */
class BcTransactionMasterMonth extends \bc\modules\transaction\models\summary\SummaryActiveRecord {
    ...
    public function getBctransaction() {
        return $this->hasMany(BcTransactionMonthlyReport::className(), ['month_id' => 'id']);
    }
