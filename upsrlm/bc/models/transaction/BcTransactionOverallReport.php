...
/**
 * This is the model class for table "bc_transaction_overall_report".
 *
 * @property int $id
 ...
 * @property int $status
 */
class BcTransactionOverallReport extends \bc\models\transaction\BctransactionactiveRecord {
    ...
    public static function tableName() {
        return 'bc_transaction_overall_report';
    }
    ...
    public function rules() {
        return [
            [['bc_application_id', 'user_id', 'district_code', 'block_code', 'gram_panchayat_code', 'master_partner_bank_id', 'no_of_days', 'no_of_working_days', 'no_of_not_working_days', 'big_ticket_count', 'small_ticket_count', 'no_of_transaction', 'created_at', 'updated_at', 'status'], 'integer'],
            [['start_date'], 'safe'],
    ...
    public function attributeLabels() {
        return [
            ...
            'no_of_not_working_days' => 'Non Working Days',
    ...
    public function getBcmonthly() {
        return $this->hasMany(BcTransactionMonthlyReport::className(), ['bc_application_id' => 'bc_application_id']);
    }
