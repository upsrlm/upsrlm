 ...
 * @property int $saheli
 */
class MasterDistrict extends \bc\modules\selection\models\BcactiveRecord {
    ...
    public function getBasicprofile() {
        return $this->hasMany(\bc\modules\selection\models\SrlmBcApplication::className(), ['district_code' => 'district_code'])->select('id')->andWhere(['!=', 'srlm_bc_application.status', \bc\modules\selection\models\SrlmBcApplication::DELETE])->andWhere(['srlm_bc_application.form_number' => \bc\modules\selection\models\SrlmBcApplication::FORM_STATUS_BASIC_PROFILE])->select('id')->asArray();
    }

    public function getFamilyprofile() {
        return $this->hasMany(\bc\modules\selection\models\SrlmBcApplication::className(), ['district_code' => 'district_code'])->select('id')->andWhere(['!=', 'srlm_bc_application.status', \bc\modules\selection\models\SrlmBcApplication::DELETE])->andWhere(['srlm_bc_application.form_number' => \bc\modules\selection\models\SrlmBcApplication::FORM_STATUS_FAMILY_PROFILE])->select('id')->asArray();
    }
    ...
    public function getPart2() {
        return $this->hasMany(\bc\modules\selection\models\SrlmBcApplication::className(), ['district_code' => 'district_code'])->select('id')->andWhere(['!=', 'srlm_bc_application.status', \bc\modules\selection\models\SrlmBcApplication::DELETE])->andWhere(['srlm_bc_application.form_number' => \bc\modules\selection\models\SrlmBcApplication::FORM_STATUS_PART_1])->select('id')->asArray();
    }

    public function getPart3() {
        return $this->hasMany(\bc\modules\selection\models\SrlmBcApplication::className(), ['district_code' => 'district_code'])->select('id')->andWhere(['!=', 'srlm_bc_application.status', \bc\modules\selection\models\SrlmBcApplication::DELETE])->andWhere(['srlm_bc_application.form_number' => \bc\modules\selection\models\SrlmBcApplication::FORM_STATUS_PART_2])->select('id')->asArray();
    }

    public function getPart4() {
        return $this->hasMany(\bc\modules\selection\models\SrlmBcApplication::className(), ['district_code' => 'district_code'])->select('id')->andWhere(['!=', 'srlm_bc_application.status', \bc\modules\selection\models\SrlmBcApplication::DELETE])->andWhere(['srlm_bc_application.form_number' => \bc\modules\selection\models\SrlmBcApplication::FORM_STATUS_PART_4])->select('id')->asArray();
    }
