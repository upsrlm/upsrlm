...
/**
 * MasterPartnerBankSearch represents the model behind the search form of `bc\models\master\MasterPartnerBank`.
 */
class MasterPartnerBankSearch extends MasterPartnerBank
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['bank_name', 'bank_short_name'], 'safe'],
        ];
    }
