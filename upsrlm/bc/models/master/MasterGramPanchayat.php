 ...
 */
class MasterGramPanchayat extends \bc\modules\selection\models\BcactiveRecord {
    ...
    public function attributeLabels() {
        return [
            ...
            'master_partner_bank_id' => 'Current Partner Bank',
            'previous_master_partner_bank_id' => 'Previous Partner Bank',
        ];
    }
    ...
    public function getPbank() {
        return $this->hasOne(MasterPartnerBank::className(), ['id' => 'previous_master_partner_bank_id']);
    }
    ...
    public function getBankstatus() {
        $arr = [
            0 => '',
            1 => 'Request change bank',
            2 => 'Pending change bank',
            3 => 'Completed change bank',
        ];
        return $arr[$this->change_status];
    }
