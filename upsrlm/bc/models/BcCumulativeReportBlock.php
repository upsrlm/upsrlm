...
/**
 * This is the model class for table "bc_cumulative_report_block".
 *
 * @property int $id
 ...
 */
class BcCumulativeReportBlock extends BcactiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'bc_cumulative_report_block';
    }
    ...
    public function rules() {
        return [
            ...
            [['operational'], 'integer'],
            [['block_code', 'date'], 'unique', 'targetAttribute' => ['block_code', 'date']],
        ];
    }
