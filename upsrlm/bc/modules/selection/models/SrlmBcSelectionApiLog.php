...
/**
 * This is the model class for table "srlm_bc_selection_api_log".
 *
 * @property int $id
 ...
 */
class SrlmBcSelectionApiLog extends BcactiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'srlm_bc_selection_api_log';
    }
    ...
    public function getAppdetail() {
        return $this->hasOne(SrlmBcSelectionAppDetail::className(), ['id' => 'srlm_bc_selection_app_id']);
    }
