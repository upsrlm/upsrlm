...
/**
 * This is the model class for table "srlm_bc_application_group_family2".
 *
 * @property int $id
 ...
 * @property int $status
 */
class SrlmBcApplicationGroupFamily2 extends BcactiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'srlm_bc_application_group_family2';
    }
