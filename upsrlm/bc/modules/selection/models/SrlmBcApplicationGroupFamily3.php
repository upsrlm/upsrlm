...
/**
 * This is the model class for table "srlm_bc_application_group_family3".
 *
 * @property int $id
 ...
 * @property int $status
 */
class SrlmBcApplicationGroupFamily3 extends BcactiveRecord {
    /**
     * {@inheritdoc}
     */
    public static function tableName()
    {
        return 'srlm_bc_application_group_family3';
    }
