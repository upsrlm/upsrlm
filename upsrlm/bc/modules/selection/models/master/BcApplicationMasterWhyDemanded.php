...
/**
 * This is the model class for table "bc_application_master_why_demanded".
 *
 * @property int $id
 ...
 * @property int $status
 */
class BcApplicationMasterWhyDemanded extends \bc\modules\selection\models\BcactiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bc_application_master_why_demanded';
    }
