...
/**
 * This is the model class for table "bc_application_master_already_group_member".
 *
 * @property int $id
 ...
 * @property int $status
 */
class BcApplicationMasterAlreadyGroupMember extends \bc\modules\selection\models\BcactiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bc_application_master_already_group_member';
    }
