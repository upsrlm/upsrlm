...
/**
 * This is the model class for table "bc_application_master_can_read_write_hindi".
 *
 * @property int $id
 ...
 * @property int $status
 */
class BcApplicationMasterCanReadWriteHindi extends \bc\modules\selection\models\BcactiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bc_application_master_can_read_write_hindi';
    }
