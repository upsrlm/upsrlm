                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-info">
                                    <div class="panel-heading text-center py-2">Total Selected candidates : <?php echo $graph1['total'] ?: 0; ?></div> 
                                </div>
                            </div>
...
$script = <<< JS
    ...
    $("#Searchform").attr({ "action":"/selection/preselected/graph"});
