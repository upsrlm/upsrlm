            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function($model) use ($searchModel) {
                        $html="<a data-pjax ='0'   target='_blank' href='/selection/preselected/reportcsv?block_code=$model->block_code' ><i class='fal fa-download'></i> Download <a>";
                        return $html;
                        //return "<a data-pjax ='0'   target='_blank' href='/selection/preselected/reportpdf?DashboardSearchForm[district_code]=$model->district_code&DashboardSearchForm[block_code]=$model->block_code' >Download <a>";
