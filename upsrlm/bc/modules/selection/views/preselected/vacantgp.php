...
//        'floatHeaderOptions' => ['scrollingTop' => '50'],
                        'columns' => [
                            ...
                            [
                                ...
                                'enableSorting' => false,
                                'format' => 'raw',
                                'header' => 'No. of application',
                                'value' => function ($model) {
                                    return $model->gp->bc_selection_application_receive;
                                },
                            ],
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    return isset($arr[$model->training_status]) ? $arr[$model->training_status] : '';
                                },
                            ],
                            [
                                ...
                                'template' => '{standbybc}',
                                'buttons' => [
                                    'standbybc' => function ($url, $model) {
                                        $html = '<span id="' . $model->id . '">';
                                        if ($model->gp->first_standby_id > '1') {
                                            $html .= yii\helpers\Html::button('<i class="fa fa-thumb-up"></i> View Stand By', ['id' => 'take-stand-by-' . $model->id, 'class' => 'btn  btn-warning btn-block popb', 'value' => '/selection/preselected/standbybc?bcid=' . $model->id, 'name' => 'takeaction', 'title' => 'View Stand by BC']);
                                        }
                                        $html .= "</span>";
                                        return $html;
                                    },
