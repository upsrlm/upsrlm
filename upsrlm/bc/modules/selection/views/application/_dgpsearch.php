...
<div class="search">
    ...
    echo $form->field($model, 'district_code')->widget(kartik\select2\Select2::classname(), [
        ...
        'size' => Select2::MEDIUM,
        'options' => ['placeholder' => 'District', 'multiple' => TRUE],
        'pluginOptions' => [
            'allowClear' => true
        ],
    ]);
    ...
    <?=
    Html::a('<i class="fal fa-file-pdf"></i> Download PDF', ['/selection/application/pdfdistrictgp'], [
        'title' => 'Download PDF',
        'class' => 'btn  btn-info',
    ...
    ?>
    <?=
    Html::a('<i class="fal fa-file-excel"></i> Download CSV', ['/selection/application/csvdistrictgp'], [
        'title' => 'Download CSV',
        'class' => 'btn  btn-info',
        'class' => 'btn btn-primary btn-md py-2 px-3',
        'data-pjax' => 0
