...
class BcApplication2 {
    ...
    public function __construct($srlm_bc_application_id) {
        if (($this->srlm_bc_application_model = SrlmBcApplication2::findOne($srlm_bc_application_id)) !== null) {
            
        }
    }

    public static function getObject($srlm_bc_application_id) {
        return new BcApplication2($srlm_bc_application_id);
    }
    ...
    public function calculaterating() {
        try {
            ...
            if ($model->rating_process_status == 0 and $model->form_number == 6) {
                ...
                $this->srlm_bc_application_group_family = $model->getFamily()->where(['!=', 'srlm_bc_application_group_family2.mobile_no', '0000000000'])->count();
