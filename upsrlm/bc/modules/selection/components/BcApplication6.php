...
class BcApplication6 {
    ...
    public function __construct($srlm_bc_application_id) {
        if (($this->srlm_bc_application_model = SrlmBcApplication6::findOne($srlm_bc_application_id)) !== null) {
    ...
    public function calculaterating() {
        try {
            ...
            if ($model->rating_process_status == 0 and $model->form_number == 6) {
                ...
                $this->srlm_bc_application_group_family = $model->getFamily()->where(['!=', 'srlm_bc_application_group_family6.mobile_no', '0000000000'])->count();
