...
echo $form->field($model, 'second_complete')->label('Second Phase complete application')->widget(Select2::classname(), [
    'data' => range(0, 10),
...
$script = <<< JS
    ...
    $("#Searchform").attr({ "action":"/selection/phase2/application/gp"});
...
$js = <<<js
        ...
        $(document).ready(function(){
            $("#download").click(function(event){
              $("#Searchform").attr({ "action":"/selection/phase2/application/pdfgp"});
              $("#Searchform").removeAttr("data-pjax");
              $("#Searchform").submit();
            });
         $("#downloadcsv").click(function(event){
              $("#Searchform").attr({ "action":"/selection/phase2/application/csvgp"});
              $("#Searchform").removeAttr("data-pjax");
              $("#Searchform").submit();
            });
