...
?>
    ...
    <div class="col-xl-2 col-md-4 mb-2">
        <?= Html::submitButton('<i class="fal fa-search"></i>Search', ['class' => 'btn btn-primary ', 'id' => 'searchbtn', 'name' => 'search', 'value' => 'search','style'=>'padding:7px 20px;']) ?>
        <?= Html::button('Reset', ['class' => 'btn  btn-primary reset', 'id' => 'reloads','style'=>'padding:7px 20px;margin-left:10px']) ?>
    </div>
</div>
