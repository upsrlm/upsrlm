...
$this->title = 'SRLM BC Selection : Single application';
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    $status = '';
                                    //return $model->name;
                                    return Html::a($model->name, "/selection/phase2/application/view?id=" . $model->id, ['target' => '_blank', 'data-pjax' => "0"]) . $status;
