...
<?= Html::button('<i class="fa fa-file-pdf-o"></i> Download PDF', ['class' => 'btn  btn-primary', 'id' => 'download', 'name' => 'download', 'value' => 'download', 'style' => 'padding:7px 20px;']) ?>
...
$js = <<<js
        ...
        $(document).ready(function(){
            $("#download").click(function(event){
              $("#Searchform").attr({ "action":"/selection/phase4/application/reportpdf"});
              $("#Searchform").removeAttr("data-pjax");
              $("#Searchform").submit();
            });
        $("#searchbtn").click(function(event){
                $("#Searchform").attr({ "action":"/selection/phase4/application/report"});
