...
//        $registeruser = \Yii::$app->dbbc->createCommand("SELECT 'COUNT(id)' FROM srlm_bc_selection_user")->queryOne(); 
        $registeruser = \bc\modules\selection\models\SrlmBcSelectionUser::find()->select('id')->count();
...
//                }
//            }
//            $dataProvider2 = $searchModels->searchc($searchModel, Yii::$app->user->identity, \Yii::$app->params['page_size30']);
...
//                }
//            }
//            $dataProvider2a = $searchModels->searchc($searchModel, Yii::$app->user->identity, \Yii::$app->params['page_size30']);
