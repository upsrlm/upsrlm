...
class DashboardController extends Controller {
    ...
    public function actionIndex() {
        ...
        $registeruser = \bc\modules\selection\models\SrlmBcSelectionUser::find()->select(['id'])->where(['phase' => 6])->count();
    ...
    public function actionDownload() {
        ...
        foreach ($models as $model) {
            ...
            $row = [
                ...
                $model->form_number,
                $form_start_date,
                SrlmBcApplication6::find()->select('id')->where(['mobile_number' => $model->mobile_number, 'form_number' => 6])->asArray()->count(),
                SrlmBcApplication6::find()->select('id')->where(['aadhar_number' => $model->aadhar_number, 'form_number' => 6])->asArray()->count(),
