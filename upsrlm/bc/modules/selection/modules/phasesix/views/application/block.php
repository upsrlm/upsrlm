                    ...
                    GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    return \bc\models\master\MasterGramPanchayat::find()->joinWith(['gpdetail'])->where(['status' => 1, 'six_vacant' => 1, 'block_code' => $model->block_code])->count();
                                }
                            ],
                            [
                                ...
                                'value' => function ($model) {
                                    return \bc\models\master\MasterGramPanchayat::find()->joinWith(['gpdetail'])->where(['status' => 1, 'six_vacant' => 1, 'six_complete' => 0, 'block_code' => $model->block_code])->count();
                                }
                            ],
                        ],
                    ]);
