                    ...
                    GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    return \bc\models\master\MasterGramPanchayat::find()->joinWith(['gpdetail'])->where(['status' => 1, 'fifth_vacant' => 1, 'district_code' => $model->district_code])->count();
                                }
                            ],
                            [
                                ...
                                'value' => function ($model) {
                                    return \bc\models\master\MasterGramPanchayat::find()->joinWith(['gpdetail'])->where(['status' => 1, 'fifth_vacant' => 1, 'fifth_complete' => 0, 'district_code' => $model->district_code])->count();
                                }
                            ],
                        ],
                    ]);
