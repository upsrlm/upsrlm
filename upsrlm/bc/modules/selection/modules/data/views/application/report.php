...
//            ],
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    $html .= yii\helpers\Html::button('<i class="fal fa-check"></i> Pre Select', ['id' => 'call' . $model->id, 'class' => 'btn  btn-info btn-block popb', 'value' => '/srlm/data/bcselection/view?id=' . $model->id, 'name' => 'viewdata', 'title' => 'View Data : ' . $status]);
                                    $html .= yii\helpers\Html::button('<i class="fal fa-task"></i> First standby', ['id' => 'call' . $model->id, 'class' => 'btn  btn-success btn-block popb', 'value' => '/srlm/data/bcselection/view?id=' . $model->id, 'name' => 'viewdata', 'title' => 'View Data : ' . $status]);
                                    $html .= yii\helpers\Html::button('<i class="fal fa-eye-slash"></i> Hide', ['id' => 'call' . $model->id, 'class' => 'btn  btn-warning btn-block popb', 'value' => '/srlm/data/bcselection/view?id=' . $model->id, 'name' => 'viewdata', 'title' => 'View Data : ' . $status]);
...
$script = <<< JS
    ...
    $("#Searchform").attr({ "action":"/selection/data/application/report"});
