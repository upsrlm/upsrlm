        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <?php
                    $html = '';
                    if (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN]) and $model->form_number == 6 and $model->gender == 2) {
                        if (in_array($model->status, [SrlmBcApplication::STATUS_RECIEVED, SrlmBcApplication::STATUS_PROVISIONAL, SrlmBcApplication::STATUS_STAND_BY_1, SrlmBcApplication::STATUS_STAND_BY_2])) {
//                        $html .= Html::a('<span class="fa fa-thumbs-up">Selected</span>', ['/selection/data/application/selected', 'id' => $model->id], [
//                                    'title' => 'Selected',
//                                    'class' => 'btn btn-md btn-yellow',
//                                    'data-pjax' => "0",
//                                    'target' => '_blank',
//                                    'data-confirm' => "Are you sure you want to select this? This action can't be undone?",
//                                    'data-method' => 'POST',
//                                ]) . ' ';
                        }
                        if (in_array($model->status, [SrlmBcApplication::STATUS_RECIEVED, SrlmBcApplication::STATUS_PROVISIONAL])) {
//                        $html .= ' ' . Html::a('<span class="fa fa-recycle"> First standby</span>', ['/selection/data/application/standby1', 'id' => $model->id], [
//                                    'title' => 'First standby',
//                                    'class' => 'btn btn-md btn-danger',
//                                    'data-pjax' => "0",
//                                    'target' => '_blank',
//                                    'data-confirm' => "Are you sure you want to First standby this ?This action can't be undone?",
//                                    'data-method' => 'POST',
//                                ]) . ' ';
                        }
                        if (in_array($model->status, [SrlmBcApplication::STATUS_RECIEVED, SrlmBcApplication::STATUS_PROVISIONAL])) {
//                        $html .= ' ' . Html::a('<span class="fa fa-recycle">Second Standby</span>', ['/selection/data/application/standby2', 'id' => $model->id], [
//                                    'title' => 'Second Standby',
//                                    'class' => 'btn btn-md btn-danger',
//                                    'data-pjax' => "0",
//                                    'target' => '_blank',
//                                    'data-confirm' => "Are you sure you want to Second Standby this ?This action can't be undone?",
//                                    'data-method' => 'POST',
//                                ]) . ' ';
                        }
                    }
                    ...
                    <div class="row panel">
                        ...
                        <div class="col-md-12">
                            <div class='box bordered-box blue-border' style='margin-bottom:0;'>
                                <div class='box-header blue-background'>
                                    <div class='text-center'>OTP Verified mobile no : <?= Utility::mask($model->mobile_no) ?> </div>
