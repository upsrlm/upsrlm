...
$option = GenralModel::form_data_validation_option();
$option[0] = 'No Validation';
?>
<div class="row">
    ...
    <div class="col-xl-2 col-md-4 mb-2">
        ...
        <?php
        echo $form->field($model, 'section_at')->widget(Select2::classname(), [
    ...
    <div class="col-xl-2 col-md-4 mb-2">
        ...
        <?php
        echo $form->field($model, 'form_data_validate')->widget(Select2::classname(), [
            'data' => $option,
            'options' => ['placeholder' => 'Select Application data validation', 'style' => 'width:250px'],
            'pluginOptions' => [
                'allowClear' => true
            ],
        ]);
    ...
    <div class="col-xl-2 col-md-4 mb-2">
        ...
        <?= Html::button('Reset', ['class' => 'btn  btn-primary reset', 'style' => 'margin-left:10px;padding:7px 20px;', 'id' => 'reloads']) ?>
    </div>
</div>
