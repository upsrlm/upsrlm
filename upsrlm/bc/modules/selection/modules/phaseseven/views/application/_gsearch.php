...
<div class="row">
    ...
    <div class="col-xl-2 col-md-4 mb-2">
        <?php
        echo $form->field($model, 'seventh_complete')->label('Six Phase complete application')->widget(Select2::classname(), [
            'data' => range(0, 40),
...
$script = <<< JS
    ...
    $("#Searchform").attr({ "action":"/selection/phase7/application/gp"});
...
$js = <<<js
        ...
        $(document).ready(function(){
            $("#download").click(function(event){
              $("#Searchform").attr({ "action":"/selection/phase7/application/pdfgp"});
              $("#Searchform").removeAttr("data-pjax");
              $("#Searchform").submit();
            });
         $("#downloadcsv").click(function(event){
              $("#Searchform").attr({ "action":"/selection/phase7/application/csvgp"});
              $("#Searchform").removeAttr("data-pjax");
              $("#Searchform").submit();
            });
