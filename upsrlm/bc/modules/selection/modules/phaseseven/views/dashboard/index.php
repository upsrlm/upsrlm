...
<div class="row">
                    ...
                    <div class="col-lg-12 applicant" id="printcontaineer">
                        ...
                        if (isset($button_type) and $button_type != '') {
                            ...
                            <div class="card-body">
                                <?php
                                if ($button_type == "1") {
                                    echo $this->render('@bc/modules/selection/modules/phaseseven/views/application/bcselection_covered', ['searchModel' => $searchModel,
                                        'dataProvider' => $dataProvider,
                                        'button_type' => $button_type,
                                        'form' => $form
                                    ]);
                                } elseif ($button_type == "3") {
                                    echo $this->render('@bc/modules/selection/modules/phaseseven/views/application/bcselection_incomplete', ['searchModel' => $searchModel,
                                        'dataProvider' => $dataProvider,
                                        'button_type' => $button_type,
                                        'form' => $form
                                    ]);
                                } elseif ($button_type == "3a") {
                                    echo $this->render('@bc/modules/selection/modules/phaseseven/views/application/bcselection_incomplete_women', ['searchModel' => $searchModel,
                                        'dataProvider' => $dataProvider,
                                        'button_type' => $button_type,
                                        'form' => $form
                                    ]);
                                } elseif ($button_type == "2") {
                                    echo $this->render('@bc/modules/selection/modules/phaseseven/views/application/bcselection_completed', ['searchModel' => $searchModel,
                                        'dataProvider' => $dataProvider,
                                        'button_type' => $button_type,
                                        'form' => $form
                                    ]);
                                } elseif ($button_type == "2a") {
                                    echo $this->render('@bc/modules/selection/modules/phaseseven/views/application/bcselection_completed_women', ['searchModel' => $searchModel,
                                        'dataProvider' => $dataProvider,
                                        'button_type' => $button_type,
                                        'form' => $form
                                    ]);
    ...
    $("#Searchform").attr({ "action":"/selection/phase7/dashboard"});
