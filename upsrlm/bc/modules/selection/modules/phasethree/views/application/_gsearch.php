...
echo $form->field($model, 'third_complete')->label('Second Phase complete application')->widget(Select2::classname(), [
    'data' => range(0, 20),
...
$script = <<< JS
    ...
    $("#Searchform").attr({ "action":"/selection/phase3/application/gp"});
...
$js = <<<js
        ...
        $(document).ready(function(){
            $("#download").click(function(event){
              $("#Searchform").attr({ "action":"/selection/phase3/application/pdfgp"});
              $("#Searchform").removeAttr("data-pjax");
              $("#Searchform").submit();
            });
         $("#downloadcsv").click(function(event){
              $("#Searchform").attr({ "action":"/selection/phase3/application/csvgp"});
              $("#Searchform").removeAttr("data-pjax");
              $("#Searchform").submit();
            });
