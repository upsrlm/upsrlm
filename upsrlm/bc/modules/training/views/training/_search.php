...
<div class="srlm-search">
    ...
    <div class="row">
        ...
        //}
        ?>
        <div class="col-xl-1 col-md-4 mb-2">
            <?php
            echo $form->field($model, 'batch_size')->widget(Select2::classname(), [
                'bsVersion' => '4.x',
                'data' => $model->batch_size_option,
                'options' => ['placeholder' => 'Batch size', 'style' => 'width:250px'],
                'pluginOptions' => [
                    'allowClear' => true
                ],
            ]);
        ...
        <div class="col-xl-1 col-md-4 mb-2">
            ...
            echo $form->field($model, 'status')->widget(Select2::classname(), [
                'bsVersion' => '4.x',
                'data' => ['1' => 'Not Concluded', '2' => 'Concluded'],
