...
<div class="shikshaantar-dashbord-search">
    ...
    ?>
        ...
        <div class="col-xl-2 col-md-4 mb-2">
            <?php
    echo $form->field($model, 'year_month_start_date')->widget(Select2::classname(), [
        'bsVersion' => '4.x',
        'data' => $model->year_month_option,
        'options' => ['style' => 'width:250px', 'placeholder' => 'Month'],
        'pluginOptions' => [
            'allowClear' => true
        ],
    ])->label('Month');
