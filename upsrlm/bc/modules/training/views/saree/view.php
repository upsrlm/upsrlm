...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    <?= $model->name . ' / ' . $model->mobile_no . ' Address ' . ' ' . $model->district_name . ' /' . $model->block_name . ' /' . $model->gram_panchayat_name ?>
                </h2>
                                        ...
                                        DetailView::widget([
                                            ...
                                            'attributes' => [
                                                ...
                                                [
                                                    ...
                                                    'label' => 'बीसी सखी यूनिफ़ॉर्म पहली साड़ी प्राप्त की',
                                                    'visible'=> isset($model->bcsaree->saree1_acknowledge),
                                                    'format' => 'html',
                                                    'value' => function ($model) {
                                                        return (isset($model->bcsaree->saree1_acknowledge) and $model->bcsaree->saree1_acknowledge==1) ? 'Yes' : '<span class="color-danger-900">No</span>';
                                                    }
                                                ],
                                                [
                                        ...
                                        DetailView::widget([
                                            ...
                                            'attributes' => [
                                               ...
                                               [
                                                    ...
                                                    'label' => 'बीसी सखी यूनिफ़ॉर्म दूसरी साड़ी प्राप्त की',
                                                    'visible'=> isset($model->bcsaree->saree2_acknowledge),
                                                    'format' => 'html',
                                                    'value' => function ($model) {
                                                        return (isset($model->bcsaree->saree2_acknowledge) and $model->bcsaree->saree2_acknowledge==1) ? 'Yes' : '<span class="color-danger-900">No</span>';
                                                    }
                                                ],
                                                [
