                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div><?= $model->bc_model->user->aadhar_front_photo != null ? '<span class="profile-picture">
                                        <img style="height:500px" src="' . $model->bc_model->aadhar_front_photo_url . '" data-src="' . $model->bc_model->aadhar_front_photo_url . '"  class="lozad img-responsive" title="aadhar_front_photo"/>
                                        </span> ' : '-' ?></div>
                        ...
                        <div class="col-lg-6">
                            <div> <?= $model->bc_model->user->aadhar_back_photo != null ? '<span class="profile-picture">
                                        <img style="height:500px" src="' . $model->bc_model->aadhar_back_photo_url . '"  data-src="' . $model->bc_model->aadhar_back_photo_url . '"  class="lozad img-responsive" title="aadhar back photo"/>
                                        </span> ' : '' ?></div>
