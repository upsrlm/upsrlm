        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    ?>
                    <?php echo $this->render('_searchbcpfmsmapping', ['model' => $searchModel]); ?>
...
//                    ],
                            [
                                ...
                                'header' => 'BC Beneficiaries code',
                                'enableSorting' => false,
                                'format' => 'raw',
                                'value' => function ($model) {
                                    return $model->participant->bc_beneficiaries_code != null ? $model->participant->bc_beneficiaries_code : '';
                                }
                            ],
                            [
                            ...
                            [
                                ...
                                'header' => 'Action',
                                'visible' => in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_DC_NRLM, MasterRole::ROLE_SPM_FINANCE]),
                                'template' => '{bcbeneficiaries} {revertbcbeneficiaries}',
                                'buttons' => [
                                    'bcbeneficiaries' => function ($url, $model) {
                                        return (($model->training_status == SrlmBcApplication::TRAINING_STATUS_PASS) and $model->participant->cbo_shg_id != null and in_array($model->participant->reading_skills, [1, 2]) and $model->participant->urban_shg == '0' and $model->participant->blocked == '0' and $model->participant->shg_bank == 2 and $model->participant->bc_bank == 2 and $model->participant->bc_beneficiaries_code == null and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_DC_NRLM])) ? Html::button('Add BC Beneficiaries code', [
                                            ...
                                            'value' => '/training/participants/bcbeneficiaries?participantid=' . $model->id,
                                            'title' => 'BC-PFMS mapping',
                                        ]) . ' ' : '';
                                    },
                                    'revertbcbeneficiaries' => function ($url, $model) {
                                        return (($model->training_status == SrlmBcApplication::TRAINING_STATUS_PASS) and $model->participant->cbo_shg_id != null and $model->participant->bc_payment_count == '0' and in_array($model->participant->reading_skills, [1, 2]) and $model->participant->urban_shg == '0' and $model->participant->blocked == '0' and $model->participant->shg_bank == 2 and $model->participant->bc_bank == 2 and $model->participant->bc_beneficiaries_code != null and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_SPM_FINANCE])) ? Html::button('Revert BC Beneficiaries code', [
                                            'data-pjax' => "0",
                                            'class' => 'btn  btn-info popb',
                                            'value' => '/training/participants/bcbeneficiariesrevert?bcid=' . $model->participant->id,
                                            'title' => 'Revert BC-PFMS mapping',
                                        ]) . ' ' : '';
                                    },
                                ]
                            ],
        ...
        $(document).ready(function(){
            $("#download").click(function(event){
              $("#Searchform").attr({ "action":"/training/participants/bcpfmsmapping"});
