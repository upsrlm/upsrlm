            ...
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    ...
                    if (isset(Yii::$app->user->identity->role) and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN])) {
                        echo Html::a('Detail View', ['/training/participants/detail?bcid=' . $model->participant->id], ['class' => 'btn btn-success', 'data-pjax' => "0"]);
                    }
                    ?>
...
//                            ],
                    ...
                    <?php } ?>
                    <?php if ($model->participant->shg_confirm_funds_return_photo != null) { ?>
                        <table class="table table-responsive">
                            <tr>
                            ...
                            <tr>
                                <td width="50%">
                                    <?= $model->participant->shg_confirm_funds_return_photo != null ? '<span class="profile-picture">
                                        <img src="' . Yii::$app->params['app_url']['bc'] . $model->participant->shg_confirm_funds_return_photo_url . '" data-src="' . Yii::$app->params['app_url']['bc'] . $model->participant->shg_confirm_funds_return_photo_url . '"  class="img-responsive lozad" title="कार्यवाही पुस्तिका की फोटो" style="cursor : pointer"/>
                                        </span> ' : '-' ?>
                                </td> 
