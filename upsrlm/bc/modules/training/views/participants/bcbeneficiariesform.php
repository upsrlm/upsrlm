...
$this->title = 'Add BC Beneficiaries code';
?>
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <?= $form->field($model, 'bc_beneficiaries_code')->textInput(['size' => 14])->hint('Example : VAUPVA00000001'); ?>
                        </div>
                        <div class="col-lg-12">
                            <?= $form->field($model, 'repeat_bc_beneficiaries_code')->textInput(['size' => 14]); ?>
                        </div>
