                            ...
                            <div class="panel panel-info">
                                <div class="col-lg-12">
                                    ...
                                    echo $form->field($model, "month")->widget(DatePicker::classname(), [
                                        'bsVersion' => '4.x',
                                        'options' => ['placeholder' => 'Month', 'value' => $model->month != null ? \Yii::$app->formatter->asDatetime($model->month, "php:M-Y") : '',],
                                    ...
                                    echo $form->field($model, "distribution_date")->widget(DatePicker::classname(), [
                                        ...
                                        'options' => ['placeholder' => 'Distribution Payment Date', 'class' => 'calculateday', 'readonly' => 'readonly'],
                                        'pickerIcon' => '<i class="fal fa-calendar-alt text-primary"></i>',
                                        'removeIcon' => '<i class="fal fa-trash text-danger"></i>',
                                        'pluginOptions' => [
                                            'orientation' => 'bottom',
                    ...
                    <tbody>
                        ...
                        foreach ($model->rows as $row) {
                            ...
                            <tr>    
                                ...
                                <td><?= isset($row[2]) ? '<span class="text-danger">' . $row[2] . '</span>' : '<span class="text-success">success</span>' ?></td>    
                            </tr>  
