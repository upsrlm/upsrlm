...
?>
    ...
    <div class="col-xl-2 col-md-4 mb-2">
        ...
        <?php if (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_SPM_FINANCE])) { ?>  
    <?= Html::button('<i class="glyphicon glyphicon-download-alt fal  fa-download"></i> Download CSV', ['class' => 'btn btn-primary ', 'style' => 'padding:7px 20px;margin-left:10px;', 'id' => 'download', 'name' => 'download', 'value' => 'download']) ?>
        <?php } ?>
    </div>
