...
$(function () {
    ...
    $('.popb').click(function(){
        ...
        $('#modal').modal('show')
         ...
         document.getElementById('modalHeader').innerHTML = '' + $(this).attr('title') + '<i class="glyphicon glyphicon-remove icon-arrow-right pull-right" data-dismiss="modal" style="cursor : pointer;color:red"></i>';     
        });
});  
