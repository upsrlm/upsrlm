...
$this->title = 'Certified BC PFMS without bank verification List';
...
//                            ],
    ...
    $('form select').on('change', function(){
     $("#Searchform").attr({ "action":"/training/preselected/pfmswobankverification"});                        
