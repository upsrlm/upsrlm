        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <?php
                    echo $this->render('_searchpreblocked', [
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    $status = '';
                                    $html = '';
//                    $blocked = [1 => 'Mismatch BC GP and SHG GP ', 2 => 'GP Convert Urban',3=>'Education Eligibility'];
//                    if (isset($blocked[$model->blocked])) {
//                        $html .= '<div class="text-danger">' . $blocked[$model->blocked] . '</div>';
//                    }
