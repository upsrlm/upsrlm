...
use app\models\form\DashboardSearchForm;
use app\models\UserModel;
use yii\helpers\ArrayHelper;
use kartik\widgets\Select2;
use app\models\master\MasterRole;

$this->title = 'SRLM BC Selection';
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-info">
                    <div class="panel-heading text-center">Total Selected candidates : <?php echo $graph1['total'] ?: 0; ?></div> 
                </div>
            </div>
...
$script = <<< JS
    ...
    $("#Searchform").attr({ "action":"/selection/dashboard/graph/selection"});
