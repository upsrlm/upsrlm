...
$this->title = 'Registered (Batch Assigned)';
...
//                    }
                            ...
                            [
                                ...
                                'contentOptions' => ['style' => 'width: 15%'],
                                'value' => function ($model) {
                                    return isset($model->training->tbatch)? Html::a('<span class="fal"></span>'.$model->training->tbatch->batch_name, ['/training/training/view?trainingid=' . $model->training_id], [
                                    'title'=>'View training',
                                    'data-pjax' => "0",
                                    'class' => 'text-danger',
                                ]):'';
