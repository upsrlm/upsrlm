...
<div class="col-xl-2 col-md-4 mb-2">
<?php //if (isset(Yii::$app->user->identity->role) and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN])) { ?>
<?php
...
<?= Html::button('Reset', ['class' => 'btn  btn-primary reset', 'style' => 'mpadding:7px 20px;margin-left:10px', 'id' => 'reloads']) ?>
</div>
