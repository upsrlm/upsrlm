...
$this->title = 'SRLM BC Selection : Reason for Ineligible';
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    if (in_array($model->training_status, [55]) and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_RSETIS_DISTRICT_UNIT])) {

                                        $html .= yii\helpers\Html::button('<i class="fa fa-thumb-down"></i> Reason for Ineligible', ['id' => 'take-Ineligible-' . $model->id, 'style' => 'margin-top:5px', 'class' => 'btn  btn-block btn-info btn-block popb', 'value' => '/training/preselected/ineligibletemp?id=' . $model->id, 'name' => 'takeaction', 'title' => 'Reason for Ineligible']) . '<br/>';
                                    }
