...
$this->title = "Certified BC Unwiling (Verification pending At)";
...
//                                    ],
                                    ...
                                    [
                                        ...
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return isset($model->bc_unwilling_bank_date) ? $model->bc_unwilling_bank_date : '';
                                        }
                                    ],
                                    [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            ...
                                            return isset($model->bc_unwilling_bc_date) ? $model->bc_unwilling_bc_date : '';
                                        }
                                    ],
                                    [
                                    ...
                                    [
                                        ...
                                        'format' => 'raw',
                                        'value' => function ($model) {
                                            return isset($model->bc_unwilling_cdo_date) ? $model->bc_unwilling_cdo_date : '';
                                        }
                                    ],
                                    [
    ...
    $("#search-form").attr({ "action":"/training/certified/unwillingprogress"});
