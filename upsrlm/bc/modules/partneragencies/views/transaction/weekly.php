...
//                'floatHeaderOptions' => ['scrollingTop' => '50'],
                        'columns' => [
                            ...
                            [
                                ...
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return $model->week_start_date;
                                }
                            ],
                            [
                                'attribute' => 'week_end_date',
                                'format' => 'html',
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return $model->week_end_date;
                                }
                            ],
                            [
                                'attribute' => 'no_of_bc',
