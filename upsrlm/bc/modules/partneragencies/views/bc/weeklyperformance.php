                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    return isset($model->bc) ? Html::a($model->bc->name, "/partneragencies/bc/dailyperformance?BcTransactionDailyReportSearch[bc_application_id]=" . $model->bc->id . "&BcTransactionDailyReportSearch[to_date_time]=" . $model->week_end_date . "&BcTransactionDailyReportSearch[from_date_time]=" . $model->week_start_date, ['target' => '_blank', 'data-pjax' => "0"]) : '';
