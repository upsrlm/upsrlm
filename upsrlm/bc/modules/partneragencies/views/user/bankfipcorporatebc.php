            ...
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    <?php if (isset(Yii::$app->user->identity->role) and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_BANK_DISTRICT_UNIT])) { ?>
                        <?= Html::a('Add New User', ['addcorporatebcs'], ['class' => 'btn btn-success']) ?>
                    <?php } ?>
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    $html .= Html::a('<i class="fal fa fa-eye"></i>', ['/partneragencies/user/view', 'userid' => $model->id], [
                                        ...
                                        $html .= Html::a('<i class="fal fa fa-edit"></i>', ['/partneragencies/user/updatebankfipcorpratebc', 'userid' => $model->id], [
                                                    'title' => 'Update User',
                                                    'data-pjax' => "0",
                                                    'class' => 'btn  btn-info  mb-2',
                                                ]) . ' ';
