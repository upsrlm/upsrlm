...
//                        'contentOptions' => ['style' => 'width: 10%'],
                            ...
                            [
                                ...
                                'format' => 'raw',
                                'value' => function ($model) {
                                    return $model->participant->beneficiaries_code != null ? '<span class="text-success">Yes</span>' : '<span class="text-danger">No</span>';
                                }
                            ],
                            [
                            ...
                            [
                                ...
                                'format' => 'raw',
                                'value' => function ($model) {
                                    return $model->participant->bc_handheld_machine_recived == 1 ? '<span class="text-success">Yes</span>' : '<span class="text-danger">No</span>';
                                }
                            ],
                            [
                                ...
                                'format' => 'raw',
                                'value' => function ($model) {
                                    return $model->participant->pan_card_status == 1 ? '<span class="text-success">Yes</span>' : '<span class="text-danger">No</span>';
                                }
                            ],
                            [
                                ...
                                'format' => 'raw',
                                'value' => function ($model) {
                                    return $model->participant->pan_photo_upload == 1 ? '<span class="text-success">Yes</span>' : '<span class="text-danger">No</span>';
                                }
                            ],
