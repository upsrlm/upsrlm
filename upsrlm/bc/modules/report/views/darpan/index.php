    ...
    <div class="col-xl-12">
                        ...
                        'afterHeader' => true ? [
                                [
                                    'columns' => [
                                        ...
                                        ['content' => $searchModel->getTotaltc(), 'options' => ['colspan' => 1, 'class' => 'font-weight-bold bg-warning-100']],
                                        ['content' => $searchModel->getTotaloperational(), 'options' => ['colspan' => 1, 'class' => 'font-weight-bold bg-warning-100']],
                        ...
                        'columns' => [
                            ...
                            [
                                'attribute' => 'trained_and_certified',
                                 'enableSorting' => false,
                                'value' => function ($model) {
                                    return isset($model->trained_and_certified) ? $model->trained_and_certified : '';
                                }
                            ],
                            [
        ...
        $(document).ready(function(){
            $("#download").click(function(event){
              $("#Searchform").attr({ "action":"/report/darpan/downloadmonthli"});
              $("#Searchform").removeAttr("data-pjax");
              $("#Searchform").submit();
            });
             
        $("#searchbtn").click(function(event){
                $("#Searchform").attr({ "action":"/report/darpan"});
