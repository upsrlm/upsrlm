   ...
   <thead>
    ...
    <tbody>
        ...
        <tr class="font-weight-bold bg-primary-50">
            ...
            <td class="text-center bg-primary-50"><?= '' ?></td>
...
where master_gram_panchayat.status=1 and master_gram_panchayat_detail_bc.current_available>0 and master_gram_panchayat_detail_bc.current_status IN (-100,-2,32,4,5,6,34) and master_gram_panchayat_detail_bc.issue=0 and master_gram_panchayat.master_partner_bank_id=$master_partner_bank_id
")->count() ?></td>
...
where master_gram_panchayat.status=1 and master_gram_panchayat_detail_bc.current_available=0 and master_gram_panchayat_detail_bc.current_status IN (-100,-2,32,4,5,6,34) and master_gram_panchayat_detail_bc.issue=0 and master_gram_panchayat.master_partner_bank_id=$master_partner_bank_id")->count() ?></td>
            
            <td class="text-center bg-primary-50"><?= BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'certified_bc') ?></td>
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_select_base_url. '?DashboardSearchForm[master_partner_bank_id]=' . $searchModel->master_partner_bank_id . '' ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'no_of_bc_shortlisted') - (BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'no_of_bc_registered') + BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'agree') + BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'blocked_bc'))) ?></a></td>

            <td class="text-center bg-primary-50"><?= BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'pvr') ?></td>
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_base_url . '?RsetisBatchParticipantsSearch[master_partner_bank_id]=' . $searchModel->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=pvr' ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'certified_bc') - BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'pvr')) ?></a></td>
            <td class="text-center bg-primary-50"><?= BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'shg_assigned') ?></td>
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_base_url . '?RsetisBatchParticipantsSearch[master_partner_bank_id]=' . $searchModel->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=bc_shg_assigned' ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'certified_bc') - BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'shg_assigned')) ?></a></td>
            <td class="text-center bg-primary-50"><?= BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'bc_shg_bank_verified') ?></td>
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_base_url . '?RsetisBatchParticipantsSearch[master_partner_bank_id]=' . $searchModel->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=bc_shg_bank_verified' ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'shg_assigned') - BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'bc_shg_bank_verified')) ?></a></td>
            <td class="text-center bg-primary-50"><?= BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'pfms_mapping') ?></td>
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_base_url . '?RsetisBatchParticipantsSearch[master_partner_bank_id]=' . $searchModel->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=pfms_mapping' ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'bc_shg_bank_verified') - BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'pfms_mapping')) ?></a></td>
            ...
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_base_url . '?RsetisBatchParticipantsSearch[master_partner_bank_id]=' . $searchModel->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=bc_shg_support_fund' ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'pfms_mapping') - BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'bc_support_fund_shg_transfer')) ?></a></td>
           ...
           <td class="23 text-center bg-primary-50"><?= (BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'certified_bc') - BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'shg_assigned'))+(BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'shg_assigned') - BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'bc_shg_bank_verified'))+(BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'bc_shg_bank_verified') - BcCumulativeReportDistrictPartnerBank::getTotal($dataProvider->models, 'pfms_mapping')) ?></td>
...
where master_gram_panchayat.status=1 and master_gram_panchayat.district_code=".$model->district_code." and master_gram_panchayat_detail_bc.current_available=0 and master_gram_panchayat_detail_bc.current_status IN (-100,-2,32,4,5,6,34) and master_gram_panchayat_detail_bc.issue=0")->count() ?></td>
                ...
                <td colspan="1" class="text-center bg-warning-50"><a href="<?= $searchModel->district_select_base_url . '?DashboardSearchForm[district_code]=' . $model->district_code . '&DashboardSearchForm[master_partner_bank_id]='.$model->master_partner_bank_id ?>" data-pjax="0" target="_blank"><?= ($model->no_of_bc_shortlisted - ($model->no_of_bc_registered + $model->agree + $model->blocked_bc)) ?></a></td>
