...
<table id='report' class="table table-striped  table-bordered tbl_sort">
     <thead>
         <tr>
            ...
            <th colspan="2" class="text-center bg-warning-50">RSETI</th>
        ...
        <tr>
            ...
            <th colspan="2" class="text-center bg-danger-200">Certified BC</th>
            ...
            <th colspan="1" class="text-center">Total target</th>
        </tr>
...
where master_gram_panchayat.status=1  and master_gram_panchayat.district_code=".$dis_model->district_code."  and master_gram_panchayat_detail_bc.current_available>0 and master_gram_panchayat_detail_bc.current_status IN (-100,-2,32,4,5,6,34) and master_gram_panchayat_detail_bc.issue=0  and master_gram_panchayat.master_partner_bank_id=$master_partner_bank_id
")->count() ?></td>
...
where master_gram_panchayat.status=1 and master_gram_panchayat.district_code=".$dis_model->district_code." and master_gram_panchayat_detail_bc.current_available=0 and master_gram_panchayat_detail_bc.current_status IN (-100,-2,32,4,5,6,34) and master_gram_panchayat_detail_bc.issue=0  and master_gram_panchayat.master_partner_bank_id=$master_partner_bank_id")->count() ?></td>
            
            <td class="text-center bg-primary-50"><?= BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'certified_bc') ?></td>
            
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_select_base_url. '?DashboardSearchForm[district_code]=' . $dis_model->district_code. '&DashboardSearchForm[master_partner_bank_id]='.$searchModel->master_partner_bank_id ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'no_of_bc_shortlisted') - (BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'no_of_bc_registered') + BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'agree') + BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'blocked_bc'))) ?></a></td>
            
            <td class="text-center bg-primary-50"><?= BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'pvr') ?></td>
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_base_url. '?RsetisBatchParticipantsSearch[district_code]=' . $dis_model->district_code . '&RsetisBatchParticipantsSearch[master_partner_bank_id]='.$searchModel->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=pvr' ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'certified_bc') - BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'pvr')) ?></a></td>
            <td class="text-center bg-primary-50"><?= BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'shg_assigned') ?></td>
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_base_url. '?RsetisBatchParticipantsSearch[district_code]=' . $dis_model->district_code . '&RsetisBatchParticipantsSearch[master_partner_bank_id]='.$searchModel->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=bc_shg_assigned' ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'certified_bc') - BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'shg_assigned')) ?></a></td>
            <td class="text-center bg-primary-50"><?= BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'bc_shg_bank_verified') ?></td>
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_base_url. '?RsetisBatchParticipantsSearch[district_code]=' . $dis_model->district_code . '&RsetisBatchParticipantsSearch[master_partner_bank_id]='.$searchModel->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=bc_shg_bank_verified' ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'shg_assigned') - BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'bc_shg_bank_verified')) ?></a></td>
            <td class="text-center bg-primary-50"><?= BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'pfms_mapping') ?></td>
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_base_url. '?RsetisBatchParticipantsSearch[district_code]=' . $dis_model->district_code . '&RsetisBatchParticipantsSearch[master_partner_bank_id]='.$searchModel->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=pfms_mapping' ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'bc_shg_bank_verified') - BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'pfms_mapping')) ?></a></td>
            ...
            <td class="text-center bg-primary-50"><a href="<?= $searchModel->district_base_url. '?RsetisBatchParticipantsSearch[district_code]=' . $dis_model->district_code . '&RsetisBatchParticipantsSearch[master_partner_bank_id]='.$searchModel->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=bc_shg_support_fund' ?>" data-pjax="0" target="_blank"><?= (BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'pfms_mapping') - BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'bc_support_fund_shg_transfer')) ?></a></td>
            ...
            <td class="23 text-center bg-primary-50"><?= (BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'certified_bc') - BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'shg_assigned'))+(BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'shg_assigned') - BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'bc_shg_bank_verified'))+(BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'bc_shg_bank_verified') - BcCumulativeReportBlockPartnerBank::getTotal($dataProvider->models, 'pfms_mapping')) ?></td>
...
where master_gram_panchayat.status=1  and master_gram_panchayat.block_code=".$model->block_code."  and master_gram_panchayat_detail_bc.current_available>0 and master_gram_panchayat_detail_bc.current_status IN (-100,-2,32,4,5,6,34) and master_gram_panchayat_detail_bc.issue=0  and master_gram_panchayat.master_partner_bank_id=$master_partner_bank_id
")->count() ?></td>
...
where master_gram_panchayat.status=1 and master_gram_panchayat.block_code=".$model->block_code." and master_gram_panchayat_detail_bc.current_available=0 and master_gram_panchayat_detail_bc.current_status IN (-100,-2,32,4,5,6,34) and master_gram_panchayat_detail_bc.issue=0 and master_gram_panchayat.master_partner_bank_id=$master_partner_bank_id")->count() ?></td>
            
                <td class="text-center"><?= $model->certified_bc ?></td>
                <td colspan="1" class="text-center bg-warning-50"><a href="<?= $searchModel->district_select_base_url. '?DashboardSearchForm[district_code]=' . $dis_model->district_code.'&DashboardSearchForm[block_code]='.$model->block_code. '&DashboardSearchForm[master_partner_bank_id]='.$model->master_partner_bank_id ?>" data-pjax="0" target="_blank"><?= ($model->no_of_bc_shortlisted - ($model->no_of_bc_registered + $model->agree + $model->blocked_bc)) ?></a></td>
                
                <td colspan="1" class="text-center"><?= $model->pvr ?></td>
                <td colspan="1" class="text-center bg-warning-50"><a href="<?= $searchModel->district_base_url. '?RsetisBatchParticipantsSearch[district_code]=' . $dis_model->district_code .'&RsetisBatchParticipantsSearch[block_code]=' . $model->block_code. '&RsetisBatchParticipantsSearch[master_partner_bank_id]='.$model->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=pvr' ?>" data-pjax="0" target="_blank"><?= ($model->certified_bc - $model->pvr) ?></a></td>
                <td colspan="1" class="text-center"><?= $model->shg_assigned ?></td>
                <td colspan="1" class="text-center bg-warning-50"><a href="<?= $searchModel->district_base_url. '?RsetisBatchParticipantsSearch[district_code]=' . $dis_model->district_code .'&RsetisBatchParticipantsSearch[block_code]=' . $model->block_code. '&RsetisBatchParticipantsSearch[master_partner_bank_id]='.$model->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=bc_shg_assigned' ?>" data-pjax="0" target="_blank"><?= ($model->certified_bc - $model->shg_assigned) ?></a></td>
                ...
                <td colspan="1" class="text-center bg-warning-50"><a href="<?= $searchModel->district_base_url. '?RsetisBatchParticipantsSearch[district_code]=' . $dis_model->district_code .'&RsetisBatchParticipantsSearch[block_code]=' . $model->block_code. '&RsetisBatchParticipantsSearch[master_partner_bank_id]='.$model->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=pfms_mapping' ?>" data-pjax="0" target="_blank"><?= ($model->bc_shg_bank_verified - $model->pfms_mapping) ?></a></td>
                <td colspan="1" class="text-center"><?= $model->bc_support_fund_shg_transfer ?></td>
                <td colspan="1" class="text-center bg-warning-50"><a href="<?= $searchModel->district_base_url. '?RsetisBatchParticipantsSearch[district_code]=' . $dis_model->district_code .'&RsetisBatchParticipantsSearch[block_code]=' . $model->block_code. '&RsetisBatchParticipantsSearch[master_partner_bank_id]='.$model->master_partner_bank_id . '&RsetisBatchParticipantsSearch[pendency]=bc_shg_support_fund' ?>" data-pjax="0" target="_blank"><?= ($model->pfms_mapping - $model->bc_support_fund_shg_transfer) ?></a></td>
