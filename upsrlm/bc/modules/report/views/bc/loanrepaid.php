        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <?php echo $this->render('_searchloanrepaid', ['model' => $searchModel]); ?>
...
//                            ],
                            ...
                            [
                                ...
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return isset($model->trans->transaction_start_date) ? \Yii::$app->formatter->asDatetime($model->trans->transaction_start_date, "php:d M-Y") : '';
                                }
                            ],
                            [
                                ...
                                'value' => function ($model) {
                                    return isset($model->trans->no_of_transaction) ? $model->trans->no_of_transaction : '';
                                }
                            ],
                            [
                                ...
                                'header' => 'Txn Amount',
                                'value' => function ($model) {
                                    return isset($model->trans->transaction_amount) ? common\helpers\Utility::numberIndiaStyle($model->trans->transaction_amount) : '';
                                }
                            ],
                            [
                                ...
                                'value' => function ($model) {
                                    return isset($model->trans->commission_amount) ? common\helpers\Utility::numberIndiaStyle($model->trans->commission_amount) : '';
                                }
                            ],
                            [
                                ...
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return isset($model->trans->total_working_day) ? $model->trans->total_working_day : '';
                                }
                            ],
                            [
                                ...
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return isset($model->participant->bc_return_amount) ? $model->participant->bc_return_amount : '';
                                }
                            ],
//                            [
...
//                            ],
                            [
                                'attribute' => 'कार्यवाही पुस्तिका की फोटो',
                                'format' => 'raw',
                                'value' => function ($model) {
                                    $status = '';
                                    $html = '<span id="' . $model->id . '">';

                                    $html .= $model->participant->shg_confirm_funds_return_photo != null ? '<span class="profile-picture">
                                        <img width="150px" height="150px" data-src="' . \Yii::$app->params['app_url']['bc'] . $model->participant->shg_confirm_funds_return_photo_url . '" src="' . \Yii::$app->params['app_url']['bc'] . $model->participant->shg_confirm_funds_return_photo_url . '"  class="lozad" title="कार्यवाही पुस्तिका की फोटो" style="cursor : pointer"/>
                                        </span> ' : '';
        ...
        $("#searchbtn").click(function(event){
                $("#Searchform").attr({ "action":"/report/bc/loanrepaid"});
