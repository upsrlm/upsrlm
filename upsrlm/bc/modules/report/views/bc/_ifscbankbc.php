...
$dataProvider->query->andWhere(['branch_code_or_ifsc' => $model->branch_code_or_ifsc]);
$dataProvider->query->andWhere(['bank_id' => $model->bank_id]);
?>
<div class="row">
    <div class="col-xl-12">
                                    ...
                                    'bc194n' => function ($url, $model) {
                                        ...
                                        if ($model->bc_settlement_ac_194n == 0) {
                                            ...
                                            if (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_RBI])) {
                                                ...
                                                $html.=Html::a('', "/report/bc/setelmentac194n?bcid=" . $model->id, ['target' => '_blank', 'data-pjax' => "0",'class' => 'btn  btn-danger',]);
