...
<div class="srlm-search">
    ...
    <div class="row">
        ...
        <?php if (!Yii::$app->user->isGuest && (!in_array(Yii::$app->user->identity->id, \bc\modules\selection\models\base\GenralModel::rbi_user_id()))) { ?>
            <div class="col-xl-2 col-md-4 mb-2">
                <?php
                echo $form->field($model, 'bc_settlement_account_bank_name')->widget(Select2::classname(), [
                    'bsVersion' => '4.x',
        ...
        <div class="col-xl-2 col-md-4 mb-2">
            ...
            <?php if (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_RBI] ) and $model->bc_settlement_account_bank_name) { ?>
                <?php echo Html::button('<i class="glyphicon glyphicon-download-alt fal fa-download"></i> Download Excel', ['class' => 'btn btn-primary ', 'style' => 'padding:7px 20px;margin-left:10px;', 'id' => 'download', 'name' => 'download', 'value' => 'download']) ?>
            <?php } ?>
