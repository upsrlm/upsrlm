        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    ?>
                    <?php
                    echo $this->render('_searchweekly', [
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    return isset($model->bc) ? Html::a($model->bc->name, "/transaction/bc/dailyperformance?BcTransactionBcSummaryDailySearch[bc_application_id]=" . $model->bc->id . "&BcTransactionBcSummaryDailySearch[to_date_time]=" . $model->week_end_date . "&BcTransactionBcSummaryDailySearch[from_date_time]=" . $model->week_start_date, ['target' => '_blank', 'data-pjax' => "0"]) : '';
...
//                            ],
                            [
                                ...
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return isset($model->week) ? \Yii::$app->formatter->asDatetime($model->week_start_date, "php:d M Y") . ' to ' . \Yii::$app->formatter->asDatetime($model->week_end_date, "php:d M Y") : '';
                                }
                            ],
                            [
                                'attribute' => 'total_working_day',
                                'header'=>"No. of days worked in the week",
                                'enableSorting' => false,
                                'value' => function ($model) {
        ...
        $(document).ready(function(){
            $("#download").click(function(event){
              $("#Searchform").attr({ "action":"/transaction/bc/downloadweekly"});
              $("#Searchform").removeAttr("data-pjax");
              $("#Searchform").submit();
            });
             
        $("#searchbtn").click(function(event){
                $("#Searchform").attr({ "action":"/transaction/bc/weeklyperformance"});
