...
/**
 * This is the model class for table "bc_tracking_bc_date_range".
 *
 * @property int $id
 ...
 */
class BcTrackingBcDateRange extends SummaryActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'bc_tracking_bc_date_range';
    }
    ...
    public function rules() {
        return [
            ...
            [['transaction_start_date', 'date_from', 'date_to'], 'safe'],
    ...
    public function attributeLabels() {
        return [
            ...
            'banking_partner_name' => 'Partner Name',
            'transaction_start_date' => 'Txn Start Date',
            'total_day' => 'Total Day',
            'total_working_day' => 'Working Days',
            'total_not_working_day' => 'Not Working Days',
            'total_no_of_transaction' => 'Transaction',
            ...
            'total_commission_amount' => 'Commission Amount',
            'start_month_id' => 'Start Month ID',
            'start_month_name' => 'Txn Start Month',
            'last_month_id' => 'Last Month ID',
            'last_month_name' => 'Txn Last Month',
            'days' => 'Days',
    ...
    public function afterSave($insert, $changedAttributes) {
        try {
            $bc= BcTrackingBcDateRange::findOne($this->id);
            $model = new BcTrackingBcDateRangeHistory();
            $model->setAttributes($bc->attributes);
            $model->date_time = new \yii\db\Expression('NOW()');
...
//                        exit;
    ...
    public function getCallbutton() {
        $html = '';
        $html .= \yii\helpers\Html::a('<i class="fal fa-phone"></i> कॉल करें', ['/platform/call/scenarioatend?bcid=' . $this->bc_application_id . '&scenario=550'], ['data-toggle' => "tooltip", 'data-pjax' => 0, 'class' => 'btn btn-info']);
        return $html;
    }
    ...
    public function getFb() {
        return $this->hasOne(\bc\modules\selection\models\BcTrackingFeedback::className(), ['bc_application_id' => 'bc_application_id']);
    }
