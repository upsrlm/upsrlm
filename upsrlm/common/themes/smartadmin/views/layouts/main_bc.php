...
use yii\helpers\Url;
use common\assets\SmartAdminBCAsset;
use yii\widgets\Breadcrumbs;
use kartik\widgets\AlertBlock;
use yii\helpers\ArrayHelper;

$bundle = SmartAdminBCAsset::register($this);
...
<html lang="<?= Yii::$app->language ?>" class="root-text">
    <head>
        ...
        <?= Html::csrfMetaTags() ?>
        <title>BC: <?= Html::encode($this->title) ?></title>
        <?php $this->head() ?>
    ...
    <body class="mod-bg-1 header-function-fixed nav-function-top">
        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <?=
                $this->render('left_bc.php', ['bundle' => $bundle])
                ?>
                <div class="page-content-wrapper">
                    <?=
                    $this->render('header_bc.php', ['bundle' => $bundle])
                    ?>
