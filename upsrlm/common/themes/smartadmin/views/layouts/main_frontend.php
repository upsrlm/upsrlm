...
use yii\helpers\Url;
use common\assets\SmartFrontendAsset;
use yii\widgets\Breadcrumbs;
use kartik\widgets\AlertBlock;
use yii\helpers\ArrayHelper;

$bundle = SmartFrontendAsset::register($this);
    ...
    <body class="mod-bg-1 header-function-fixed nav-function-top">
        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <?=
                $this->render('left_frontend.php', ['bundle' => $bundle])
                ?>
                <div class="page-content-wrapper">
                    <?=
                    $this->render('header_frontend.php', ['bundle' => $bundle])
                    ?>

                    <?=
                    $this->render('content_frontend.php', ['content' => $content, 'bundle' => $bundle])
                    ?>
                </div>
            </div>
        </div> 
