    ...
    <?php if (!Yii::$app->user->isGuest) { ?>
        <nav id="js-primary-nav" class="primary-nav" role="navigation">
            ...
            <ul id="js-nav-menu" class="nav-menu">
                ...
                <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_JMD, MasterRole::ROLE_SUPPORT_UNIT]))) { ?>
                    <li>
                ...
                <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_JMD, MasterRole::ROLE_SUPPORT_UNIT]))) { ?>
                    <li>
                        ...
                        <ul>
                            ...
                            <?php if (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_JMD, MasterRole::ROLE_SUPPORT_UNIT])) { ?>  
                                <li>
                                    <a href="/bc/unwilling"> 
                            ...
                            <?php if (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_JMD, MasterRole::ROLE_SUPPORT_UNIT])) { ?>  
                                <li>
                                    <a href="/bc/unwilling/certified"> 
                                        ...
                                        <span class="nav-link-text">Unwilling after certified</span> 
                                    </a>
                                </li>
                            <?php } ?>     
                            <li>
                ...
                <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_JMD, MasterRole::ROLE_SUPPORT_UNIT]))) { ?>
                    <li>
                        <a href="#" title="RSETIs Training" data-filter-tags="application intel">
                            ...
                            <span class="nav-link-text" data-i18n="nav.application_intel">RSETIs</span>
                            <b class="collapse-sign"><em class="fal fa-angle-down"></em></b>
                        </a>
                        <ul>
                            <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_JMD, MasterRole::ROLE_SUPPORT_UNIT]))) { ?>
                                <li>
                                    <a class="dropdown-item" href="/rsetis/pendency">Pendency</a>
                                </li>
                            <?php } ?>
                             <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_JMD, MasterRole::ROLE_SUPPORT_UNIT]))) { ?>
                                <li>
                                    <a class="dropdown-item" href="/rsetis/user">RSETIs District Unit </a>
                                </li>
                            <?php } ?>    
                            <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_JMD, MasterRole::ROLE_SUPPORT_UNIT]))) { ?>
                                <li>
                                    <a class="dropdown-item" href="/rsetis/preselected">Add training participants/ form batch</a>
                                </li>
                            <?php } ?>
                ...
                <?php } ?>  
                <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_SUPPORT_UNIT]))) { ?>
                    <li>
                ...
                <?php } ?>     
                <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPPORT_UNIT]))) { ?>
                    <li>
                        <a href="#" title="cbo user" data-filter-tags="application intel">
