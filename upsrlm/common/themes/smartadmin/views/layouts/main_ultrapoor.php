...
use yii\helpers\Url;
use common\assets\SmartAdminHrAsset;
use yii\widgets\Breadcrumbs;
use kartik\widgets\AlertBlock;
use yii\helpers\ArrayHelper;

$bundle = SmartAdminHrAsset::register($this);
...
<html lang="<?= Yii::$app->language ?>" class="root-text">
    <head>
        ...
        ?>
        <meta charset="utf-8" />
        <meta name="description" content="UPSRLM Ultra Poor">
        ...
        <?= Html::csrfMetaTags() ?>
        <title>UPSRLM:Ultra Poor: <?= Html::encode($this->title) ?></title>
        <?php $this->head() ?>
    ...
    <body class="mod-bg-1 header-function-fixed nav-function-top">
        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <?=
                $this->render('left_ultrapoor.php', ['bundle' => $bundle])
                ?>
                <div class="page-content-wrapper">
                    <?=
                    $this->render('header_ultrapoor.php', ['bundle' => $bundle])
                    ?>

                    <?=
                    $this->render('content_ultrapoor.php', ['content' => $content, 'bundle' => $bundle])
                    ?>
                </div>
            </div>
        </div> 
