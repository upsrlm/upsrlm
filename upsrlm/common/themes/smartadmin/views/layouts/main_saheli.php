...
<html lang="<?= Yii::$app->language ?>" class="root-text">
    <head>
        ...
        <?= Html::csrfMetaTags() ?>
        <title>Saheli Sakhi: <?= Html::encode($this->title) ?></title>
        <?php $this->head() ?>
    ...
    <body class="mod-bg-1 header-function-fixed nav-function-top">
        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <?=
                $this->render('left_saheli.php', ['bundle' => $bundle])
                ?>
                <div class="page-content-wrapper">
                    <?=
                    $this->render('header_saheli.php', ['bundle' => $bundle])
                    ?>

                    <?=
                    $this->render('content_saheli.php', ['content' => $content, 'bundle' => $bundle])
                    ?>
                </div>
            </div>
        </div> 
