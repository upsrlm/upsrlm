        ...
        <nav id="js-primary-nav" class="primary-nav" role="navigation">
            ...
            <ul id="js-nav-menu" class="nav-menu">
                ...
                <li>
                    ...
                    <ul>
                        <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_INTERNAL_CALL_CENTER_ADMIN, MasterRole::ROLE_INTERNAL_CALL_CENTER_EXECUTIVE]))) { ?>
                            <li>
                        ...
                        <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_DBT_CALL_CENTER_MANAGER, MasterRole::ROLE_DBT_CALL_CENTER_EXECUTIVE]))) { ?>
                            <li>
                                <a href="/shg/cst" title="SHG CST Member" data-filter-tags="shg dashboard">
                                    <span class="nav-link-text" data-i18n="nav.shg_dashboard">SHG CST Member</span>
                                </a>
                            </li>
                        <?php } ?>     
                    </ul>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="/report"> 
                                    ...
                                    <span class="nav-link-text">Call User Report</span> 
                                </a>
                            </li>
                ...
                <?php } ?> 
                <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_INTERNAL_CALL_CENTER_ADMIN]))) { ?>
                    <li>
