...
<aside class="page-sidebar">
    <div class="page-logo">
        <a href="/" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
            <img src="<?= $bundle->baseUrl ?>/img/logo.png" style="width: 70px" alt="Ultra Poor" aria-roledescription="logo">
    ...
    <?php if (!Yii::$app->user->isGuest) { ?>
        <nav id="js-primary-nav" class="primary-nav" role="navigation">
            ...
            <ul id="js-nav-menu" class="nav-menu">
                ...
                <?php if (!Yii::$app->user->isGuest && 0 and (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_ULTRA_POOR_VIEWER, MasterRole::ROLE_WADA_VIEWER]))) { ?>
                    <li>
                        <a href="/report/agent/progress" title="Outbound Agent Progress" data-filter-tags="upsrlm user">
                ...
                <?php } ?>   
                <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_ULTRA_POOR_VIEWER, MasterRole::ROLE_SMMU]))) { ?>
                    <li>
                        ...
                        <ul>
                            <!--                            <li>
                                                            <a href="/report/hhs/districtstatus" title="District Status"> 
                                                                <span class="nav-link-text">District Status</span>
                                                            </a>
                                                        </li>-->
                            <li>
                                <a href="/report/hhs/gpstatus" title="GP Status"> 
                                    <span class="nav-link-text">GP Status</span>
                                </a>
                            </li>
                            <li>
                                <a href="/report/hhs/district" title="Digital Verification Status - District Wise"> 
                                    <span class="nav-link-text">Digital Verification Status -  District Wise</span>
                                </a>
                            </li>

                            <li>
                                <a href="/report/hhs/block" title="Digital Verification Status - Block Wise"> 
                                    <span class="nav-link-text">Digital Verification Status - Block Wise</span>
                                </a>
                            </li>
                            <li>
                                <a href="/report/hhs/gp" title="Gram Pradhan Verification Status - GP Wise"> 
                                    <span class="nav-link-text">Gram Pradhan Verification Status - GP Wise</span>
                                </a>
                            </li>
