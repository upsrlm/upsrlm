...
$baseUrl = '/hr';  // HR module base path
?>
    ...
    <?php if (!Yii::$app->user->isGuest) { ?>
        <nav id="js-primary-nav" class="primary-nav" role="navigation">
            ...
            <ul id="js-nav-menu" class="nav-menu">
                <?php if (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_HR_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_JMD, MasterRole::ROLE_DBT_CALL_CENTER_MANAGER, MasterRole::ROLE_INTERNAL_CALL_CENTER_ADMIN,MasterRole::ROLE_DBT_CALL_CENTER_EXECUTIVE, MasterRole::ROLE_INTERNAL_CALL_CENTER_EXECUTIVE, MasterRole::ROLE_SUPPORT_UNIT])) { ?>
                <li>
                    <i class="fal fa-dashboard"></i>
                    <a href="<?= $baseUrl ?>" title="Dashboard" data-method="post">
                        <span class="nav-link-text" >Dashboard</span>
                    </a>
                </li> 
                <li>
                    <i class="fal fa-dashboard"></i>
                    <a href="<?= $baseUrl ?>/bmmu" title="BMMU Contact" data-method="post">
                        <i class="fal fa-address-book"></i>
                        <span class="nav-link-text" >BMMU Contact</span>
                    </a>
                </li> 
                 <?php } ?>
                <?php if (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_HR_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_JMD])) { ?>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?= $baseUrl ?>/user" title="Users"> 
                                    <span class="nav-link-text">Manage</span>
                                </a>
                            </li>

                            <?php if (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_HR_ADMIN])) { ?>
                                <li>
                                    <a href="<?= $baseUrl ?>/user/add" title="Add User"> 
                    ...
                    <li >
                        <a  class="dropdown-toggles" href="<?= $baseUrl ?>/user/bmmu">
                            <i class="fal fa-user"></i>
                            <span class="">BMMU</span>
                        </a>  
                    </li>
                    <li>
                        <a  class="dropdown-toggles" href="<?= $baseUrl ?>/user/dmmu">
                            <i class="fal fa-user"></i>
                            <span class="">DMMU</span>
                        </a>  
                    </li>
                    <li>
                        <a  class="dropdown-toggles" href="<?= $baseUrl ?>/user/smmu">
                            <i class="fal fa-user"></i>
                            <span class="">SMMU</span>
                        </a>  
                    </li>
                <?php } ?>
        ...
        <div class="nav-footer shadow-top">
            ...
            <ul class="list-table m-auto nav-footer-buttons">
                <li>
                    <a href="<?= $baseUrl ?>/profile/view" data-toggle="tooltip" data-placement="top" title="Profile">
                ...
                <li>
                    <a href="<?= $baseUrl ?>/site/logout" data-method="post" data-toggle="tooltip" data-placement="top" title="logout">
