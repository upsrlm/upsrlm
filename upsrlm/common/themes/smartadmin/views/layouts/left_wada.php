    ...
    <?php if (!Yii::$app->user->isGuest) { ?>
        <nav id="js-primary-nav" class="primary-nav" role="navigation">
            ...
            <ul id="js-nav-menu" class="nav-menu">
                ...
                <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_WADA_ADMIN]))) { ?>
                    <li>
                ...
                <li> 
                    ...
                    <ul>
                        <li>
                            ...
                            <a href="<?= '/changepassword' ?>" title="Change password" data-filter-tags="user change password">
        ...
        <div class="nav-footer shadow-top">
            ...
            <ul class="list-table m-auto nav-footer-buttons">
                ...
                <li>
                    <a href="<?= '/changepassword' ?>" data-toggle="tooltip" data-placement="top" title="Changepassword">
