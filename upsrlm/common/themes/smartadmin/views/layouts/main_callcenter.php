...
use yii\helpers\Url;
use common\assets\SmartAdminCallCenterAsset;
use yii\widgets\Breadcrumbs;
use kartik\widgets\AlertBlock;
use yii\helpers\ArrayHelper;

$bundle = SmartAdminCallCenterAsset::register($this);
...
<html lang="<?= Yii::$app->language ?>" class="root-text">
    <head>
        ...
        <?= Html::csrfMetaTags() ?>
        <title>SUPPORT: <?= Html::encode($this->title) ?></title>
        <?php $this->head() ?>
...
<?php $this->beginBody() ?>
        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <?=
                $this->render('left_callcenter.php', ['bundle' => $bundle])
                ?>
                <div class="page-content-wrapper">
                    <?=
                    $this->render('header_callcenter.php', ['bundle' => $bundle])
                    ?>

                    <?=
                    $this->render('content_callcenter.php', ['content' => $content, 'bundle' => $bundle])
                    ?>
                </div>
            </div>
        </div> 
