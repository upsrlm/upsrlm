...
<header class="page-header" role="banner">
    ...
    <div class="page-logo">
        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
            <img src="<?= $bundle->baseUrl ?>/img/logo.png" style="width: 70px" alt="Saheli Sakhi" aria-roledescription="logo">
    ...
    <?php if (!Yii::$app->user->isGuest) { ?>
        <div class="ml-auto d-flex">
            <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
            <img src="<?= $bundle->baseUrl ?>/img/logo_up.png" style="width: 70px" alt="Saheli Sakhi" aria-roledescription="logo">
            </a>
        </div>
    <?php } ?>
</header>