...
use yii\helpers\Url;
use common\assets\SmartAdminBCCallCenterAsset;
use yii\widgets\Breadcrumbs;
use kartik\widgets\AlertBlock;
use yii\helpers\ArrayHelper;

$bundle = SmartAdminBCCallCenterAsset::register($this);
...
<html lang="<?= Yii::$app->language ?>" class="root-text">
    <head>
        ...
        ?>
        <meta charset="utf-8" />
        <meta name="description" content="UPSRLM BC Call Center">
        ...
        <?= Html::csrfMetaTags() ?>
        <title>BC Call Center: <?= Html::encode($this->title) ?></title>
        <?php $this->head() ?>
    ...
    <body class="mod-bg-1 header-function-fixed nav-function-top">
        ...
        <div class="page-wrapper">
            <div class="page-inner">
                ...
                <?=
                $this->render('left_bccallcenter.php', ['bundle' => $bundle])
                ?>
                <div class="page-content-wrapper">
                    <?=
                    $this->render('header_bccallcenter.php', ['bundle' => $bundle])
                    ?>

                    <?=
                    $this->render('content_bccallcenter.php', ['content' => $content, 'bundle' => $bundle])
                    ?>
                </div>
            </div>
        </div> 
