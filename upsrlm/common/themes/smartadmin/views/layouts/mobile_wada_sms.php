...
use yii\helpers\Url;
use common\assets\SmartAdminWadaAsset;
use yii\widgets\Breadcrumbs;
use kartik\widgets\AlertBlock;
use yii\helpers\ArrayHelper;

$bundle = SmartAdminWadaAsset::register($this);
...
<html lang="<?= Yii::$app->language ?>" class="root-text">
    <head>
        ...
        <?= Html::csrfMetaTags() ?>
        <title>Wada Sakhi: <?= Html::encode($this->title) ?></title>
        <?php $this->head() ?>
            ...
            <div class="page-inner">
                <div class="page-content-wrapper">
                    ...
                    <header class="page-header" role="banner">
                        ...
                        <div class='page-organizations' ><img src="<?= $bundle->baseUrl ?>/img/logo.png" style="width: 60px" class="img-fluid"  alt="wada" aria-roledescription="logo"></div>

                        <div class="ml-auto d-flex">
                            <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                                <img src="<?= $bundle->baseUrl ?>/img/unicef.png" style="width: 120px" class="img-fluid"  alt="WADA" aria-roledescription="logo">
                            </a>
                            <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                                <img src="<?= $bundle->baseUrl ?>/img/logo_up.png" class="img-fluid" style="width: 60px" alt="WADA" aria-roledescription="logo">
                            </a>
                        </div>

                    </header>
                    <main id="js-page-content" role="main" class="page-content" style="padding: unset">
                        <div class="row">
