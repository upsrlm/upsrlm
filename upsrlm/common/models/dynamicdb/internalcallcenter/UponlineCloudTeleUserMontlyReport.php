...
/**
 * This is the model class for table "uponline_cloud_tele_user_montly_report".
 *
 * @property int $id
 ...
 */
class UponlineCloudTeleUserMontlyReport extends CloudTeleUserMontlyReport {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'uponline_cloud_tele_user_montly_report';
    }
    ...
    public function getUser() {
        return $this->hasOne(\common\models\online\User::className(), ['id' => 'user_id']);
    }
