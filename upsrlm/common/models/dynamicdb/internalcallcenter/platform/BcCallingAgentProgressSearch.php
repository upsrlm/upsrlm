...
/**
 * BcCallingAgentProgressSearch represents the model behind the search form of `common\models\dynamicdb\internalcallcenter\platform\BcCallingAgentProgress`.
 */
class BcCallingAgentProgressSearch extends BcCallingAgentProgress {
