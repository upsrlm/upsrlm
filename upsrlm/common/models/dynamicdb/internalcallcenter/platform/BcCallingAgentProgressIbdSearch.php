...
/**
 * BcCallingAgentProgressIbdSearch represents the model behind the search form of `common\models\dynamicdb\internalcallcenter\platform\BcCallingAgentProgressIbd`.
 */
class BcCallingAgentProgressIbdSearch extends BcCallingAgentProgressIbd
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = BcCallingAgentProgressIbd::find();
