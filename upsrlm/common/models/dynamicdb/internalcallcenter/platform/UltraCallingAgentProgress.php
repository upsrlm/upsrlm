...
/**
 * This is the model class for table "ultra_calling_agent_progress".
 *
 * @property int $id
 ...
 * @property int $status
 */
class UltraCallingAgentProgress extends \common\models\dynamicdb\internalcallcenter\InternalCallCenteractiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'ultra_calling_agent_progress';
    }
