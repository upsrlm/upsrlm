...
/**
 * This is the model class for table "calling_scneario_1001_progress".
 *
 * @property int $id
 ...
 * @property int $status
 */
class CallingScneario1001Progress extends \common\models\dynamicdb\internalcallcenter\InternalCallCenteractiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'calling_scneario_1001_progress';
    }
    ...
    public function rules() {
        return [
            ...
            [['call_scenario_id', 'work_hour', 'total_call', 'ctc_click', 'success_call', 'agent_call_recived', 'upsrlm_connection_status1', 'upsrlm_connection_status21', 'upsrlm_connection_status22', 'upsrlm_connection_status23', 'upsrlm_connection_status24', 'upsrlm_connection_status30', 'both_answered', 'from_unanswered', 'talk_duration', 'ivr_duration', 'sce_q1_none', 'sce_q1_1', 'sce_q1_2', 'sce_q2_none', 'sce_q2_1', 'sce_q2_2', 'sce_q2_3', 'sce_q3_none', 'sce_q3_1', 'sce_q3_2', 'sce_q4_none', 'sce_q4_1', 'sce_q4_2', 'sce_q4_3', 'sce_q5_none', 'sce_q5_1', 'sce_q5_2', 'created_at', 'created_by', 'updated_at', 'updated_by', 'status'], 'integer'],
