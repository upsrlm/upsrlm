...
use common\models\dynamicdb\internalcallcenter\platform\UltraPoorAgentSahayakDailyProgress;
use yii\helpers\ArrayHelper;
/**
 * UltraPoorAgentSahayakDailyProgressSearch represents the model behind the search form of `common\models\dynamicdb\internalcallcenter\platform\UltraPoorAgentSahayakDailyProgress`.
 */
class UltraPoorAgentSahayakDailyProgressSearch extends UltraPoorAgentSahayakDailyProgress
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'upsrlm_user_id', 'upsrlm_user_role', 'upsrlm_user_group', 'target', 'attempt_call', 'sms_sent', 'app_download', 'no_of_user_add', 'goverment_order_sent', 'total_ivr_time', 'total_talk_time', 'work_hour', 'created_at', 'updated_at'], 'integer'],
    ...
    {
        $query = UltraPoorAgentSahayakDailyProgress::find();
