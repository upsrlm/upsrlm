...
/**
 * This is the model class for table "calling_agent_progress_ibd".
 *
 * @property int $id
 ...
 * @property int $other_call
 * @property int $registred_call
 ...
 * @property int $status
 */
class CallingAgentProgressIbd extends \common\models\dynamicdb\internalcallcenter\InternalCallCenteractiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'calling_agent_progress_ibd';
    }
