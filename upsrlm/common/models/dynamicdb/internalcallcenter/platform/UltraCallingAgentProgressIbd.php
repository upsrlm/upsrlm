...
/**
 * This is the model class for table "ultra_calling_agent_progress_ibd".
 *
 * @property int $id
 ...
 * @property int $status
 */
class UltraCallingAgentProgressIbd extends \common\models\dynamicdb\internalcallcenter\InternalCallCenteractiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'ultra_calling_agent_progress_ibd';
    }
