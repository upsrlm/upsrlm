...
/**
 * This is the model class for table "calling_scneario_1003_progress".
 *
 * @property int $id
 ...
 * @property int $status
 */
class CallingScneario1003Progress extends \common\models\dynamicdb\internalcallcenter\InternalCallCenteractiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'calling_scneario_1003_progress';
    }
    ...
    public function rules() {
        return [
            [['call_scenario_id', 'work_hour', 'total_call', 'ctc_click', 'ibd_call', 'success_call', 'agent_call_recived', 'upsrlm_connection_status1', 'upsrlm_connection_status21', 'upsrlm_connection_status22', 'upsrlm_connection_status23', 'upsrlm_connection_status24', 'upsrlm_connection_status30', 'both_answered', 'from_unanswered', 'talk_duration', 'ivr_duration', 'sce_q1_none', 'sce_q1_1', 'sce_q1_2', 'sce_q1_3', 'sce_q1_4', 'sce_q1_5', 'sce_q1_99', 'sce_q2_none', 'sce_q2_1', 'sce_q2_2', 'sce_q3_none', 'sce_q3_1', 'sce_q3_99', 'created_at', 'created_by', 'updated_at', 'updated_by', 'status'], 'integer'],
    ...
    public function getQue1table() {
        ...
        $html .= '</tr">';
        $html .= '<tr>';
        $html .= '<th> Menu not showing in Rishta APP';
        $html .= '</th>';
        $html .= '<td>';
        $html .= $this->sce_q1_2;
        $html .= '</td">';
        $html .= '</tr>';
        $html .= '<tr>';
        $html .= '<th> Dont\'t know how to use Rishta APP?';
        $html .= '</th">';
        $html .= '<td>';
        $html .= $this->sce_q1_3;
        $html .= '</td>';
        $html .= '</tr>';
        $html .= '<tr>';
        $html .= '<th> No One Ready to become Samuh Sakhi';
        $html .= '</th>';
        $html .= '<td>';
        $html .= $this->sce_q1_4;
        $html .= '</td>';
    ...
    public function getQue3table() {
        ...
        $html .= '</tr>';
        $html .= '<tr>';
        $html .= '<th> Not a Member of SHG Anymore';
        $html .= '</th>';
        $html .= '<td>';
        $html .= $this->sce_q3_1;
        $html .= '</td>';
