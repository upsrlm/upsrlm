...
/**
 * This is the model class for table "calling_scenario_samuhsakhinotusedrishtaapp".
 *
 * @property int $id
 ...
 */
class CallingScenarioSamuhsakhinotusedrishtaapp extends \common\models\dynamicdb\internalcallcenter\InternalCallCenteractiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'calling_scenario_samuhsakhinotusedrishtaapp';
    }
    ...
    {
        return [
            [['calling_id', 'calling_agent_id', 'caller_group_id', 'rishta_shg_member_id', 'cbo_shg_id', 'member_role', 'member_user_id', 'install_rishta_app', 'have_username', 'have_otp_pin', 'smart_phone', 'have_app_link', 'call_purpose_complete', 'call_purpose_complete_no_reason', 'created_at', 'created_by', 'updated_at', 'updated_by'], 'integer'],
