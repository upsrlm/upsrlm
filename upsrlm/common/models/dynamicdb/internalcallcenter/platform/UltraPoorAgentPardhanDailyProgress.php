...
/**
 * This is the model class for table "ultra_poor_agent_pardhan_daily_progress".
 *
 * @property int $id
 ...
 */
class UltraPoorAgentPardhanDailyProgress extends \common\models\dynamicdb\internalcallcenter\InternalCallCenteractiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'ultra_poor_agent_pardhan_daily_progress';
    }
    ...
    public function rules() {
        return [
            [['upsrlm_user_id', 'upsrlm_user_role', 'upsrlm_user_group', 'target', 'attempt_call', 'sms_sent', 'app_download', 'no_of_user_add', 'total_ivr_time', 'total_talk_time', 'work_hour', 'created_at', 'updated_at'], 'integer'],
            [['date', 'call_start_time', 'call_end_time'], 'safe'],
            [['upsrlm_user_name'], 'string', 'max' => 255],
            [['upsrlm_user_mobile_no'], 'string', 'max' => 15],
            [['upsrlm_user_district', 'upsrlm_user_block'], 'safe'],
