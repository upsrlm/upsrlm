...
use common\models\dynamicdb\internalcallcenter\platform\CallingScneario1005Progress;

/**
 * CallingScneario1005ProgressSearch represents the model behind the search form of `common\models\dynamicdb\internalcallcenter\platform\CallingScneario1003Progress`.
 */
class CallingScneario1005ProgressSearch extends CallingScneario1005Progress {
    ...
    public function rules() {
        return [
            [['id', 'call_scenario_id', 'work_hour', 'total_call', 'ctc_click', 'ibd_call', 'success_call', 'agent_call_recived', 'upsrlm_connection_status1', 'upsrlm_connection_status21', 'upsrlm_connection_status22', 'upsrlm_connection_status23', 'upsrlm_connection_status24', 'upsrlm_connection_status30', 'both_answered', 'from_unanswered', 'talk_duration', 'ivr_duration', 'sce_q1_none', 'sce_q1_1', 'sce_q1_2', 'sce_q1_3', 'sce_q1_4', 'sce_q1_5', 'sce_q1_99', 'created_at', 'created_by', 'updated_at', 'updated_by', 'status'], 'integer'],
    ...
    public function search($params) {
        $query = CallingScneario1005Progress::find();
        ...
        $query->andFilterWhere([
            ...
            'sce_q1_3' => $this->sce_q1_3,
            'sce_q1_4' => $this->sce_q1_4,
            'sce_q1_5' => $this->sce_q1_5,
            'sce_q1_99' => $this->sce_q1_99,
    ...
    public function getTotacallstatus11() {
        $query = CallingScneario1005Progress::find();
        $this->basicquery($query);
    ...
    public function getTotacallstatus12() {
        $query = CallingScneario1005Progress::find();
        $this->basicquery($query);
    ...
    public function getTotacallstatus13() {
        $query = CallingScneario1005Progress::find();
        $this->basicquery($query);
    ...
    public function getQ13() {
        $query = CallingScneario1005Progress::find();
        $this->basicquery($query);
        $query->select('sce_q1_3');
        return $query->sum('sce_q1_3');
    }

    public function getQ14() {
        $query = CallingScneario1005Progress::find();
        $this->basicquery($query);
        $query->select('sce_q1_4');
        return $query->sum('sce_q1_4');
    }

    public function getQ15() {
        $query = CallingScneario1005Progress::find();
        $this->basicquery($query);
        $query->select('sce_q1_5');
        return $query->sum('sce_q1_5');
    }

    public function getQ199() {
        $query = CallingScneario1005Progress::find();
        $this->basicquery($query);
        $query->select('sce_q1_99');
        return $query->sum('sce_q1_99');
    }
    ...
    public function getQ399() {
        $query = CallingScneario1005Progress::find();
        $this->basicquery($query);
        $query->select('sce_q3_99');
        return $query->sum('sce_q3_99');
    }
