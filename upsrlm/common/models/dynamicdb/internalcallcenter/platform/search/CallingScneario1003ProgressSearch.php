...
use common\models\dynamicdb\internalcallcenter\platform\CallingScneario1003Progress;

/**
 * CallingScneario1003ProgressSearch represents the model behind the search form of `common\models\dynamicdb\internalcallcenter\platform\CallingScneario1003Progress`.
 */
class CallingScneario1003ProgressSearch extends CallingScneario1003Progress {
    ...
    public function search($params) {
        $query = CallingScneario1003Progress::find();
