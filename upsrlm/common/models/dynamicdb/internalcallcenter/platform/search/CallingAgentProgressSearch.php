...
use common\models\dynamicdb\internalcallcenter\platform\CallingAgentProgress;
 ...
 */
class CallingAgentProgressSearch extends CallingAgentProgress {
    ...
    public function rules() {
        return [
            [['id', 'calling_agent_id', 'calling_agent_role', 'work_hour', 'ctc_click', 'agent_call_recived', 'upsrlm_connection_status1', 'upsrlm_connection_status21', 'upsrlm_connection_status22', 'upsrlm_connection_status23', 'upsrlm_connection_status24', 'upsrlm_connection_status30', 'both_answered', 'from_unanswered', 'talk_duration', 'ivr_duration', 'created_at', 'created_by', 'updated_at', 'updated_by', 'status'], 'integer'],
    ...
    public function search($params) {
        $query = CallingAgentProgress::find();
