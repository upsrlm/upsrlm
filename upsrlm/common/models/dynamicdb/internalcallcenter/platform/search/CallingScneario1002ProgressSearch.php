...
use common\models\dynamicdb\internalcallcenter\platform\CallingScneario1002Progress;
use yii\helpers\ArrayHelper;

/**
 * CallingScneario1002ProgressSearch represents the model behind the search form of `common\models\dynamicdb\internalcallcenter\platform\CallingScneario1002Progress`.
 */
class CallingScneario1002ProgressSearch extends CallingScneario1002Progress {
    ...
    public function search($params) {
        $query = CallingScneario1002Progress::find();
    ...
    public function getQ44() {
        $query = CallingScneario1002Progress::find();
        $this->basicquery($query);
        $query->select('sce_q4_4');
        return $query->sum('sce_q4_4');
    }
