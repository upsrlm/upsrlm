...
use common\models\dynamicdb\internalcallcenter\platform\CallingScnearioProgress;
use \yii\helpers\ArrayHelper;
use common\models\dynamicdb\internalcallcenter\CloudTeleApiCall;

/**
 * CallingScnearioProgressSearch represents the model behind the search form of `common\models\dynamicdb\internalcallcenter\platform\CallingAgentProgress`.
 */
class CallingScnearioProgressSearch extends CallingScnearioProgress
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = CallingScnearioProgress::find();
    ...
    public function calldetailsearch($params)
    {
        ...
        $query->andFilterWhere([
            'upsrlm_call_scenario' => $this->call_scenario_id,
     ...
     * @return void
     */
    public function getCallingscnearios()
    {
        $query = CallingScnearioProgress::find();
        $query->andFilterWhere([
            'id' => $this->id,
        ...
        $query->distinct('call_scenario_id');
        return ArrayHelper::map($query->all(), 'call_scenario_id', 'scneario.call_scenario');
    }
    ...
    public function getTotalscneario()
    {
        $query = CallingScnearioProgress::find();
        $this->basicquery($query);
        $query->select('call_scenario_id');
        return $query->distinct('call_scenario_id')->count();
    }
