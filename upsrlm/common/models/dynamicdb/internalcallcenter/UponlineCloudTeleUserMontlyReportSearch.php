...
use common\models\dynamicdb\internalcallcenter\UponlineCloudTeleUserMontlyReport;

/**
 * UponlineCloudTeleUserMontlyReportSearch represents the model behind the search form of `common\models\dynamicdb\internalcallcenter\UponlineCloudTeleUserMontlyReport`.
 */
class UponlineCloudTeleUserMontlyReportSearch extends UponlineCloudTeleUserMontlyReport
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = UponlineCloudTeleUserMontlyReport::find();
