 ...
 */
class RishtaShgFeedbackSearch extends RishtaShgFeedback {
    ...
    public function search($params, $user_model = null, $pagination = true, $columns = null) {
        ...
        $query->andFilterWhere([
            ...
            \cbo\models\Shg::getTableSchema()->fullName . '.district_code' => $this->district_code,
            \cbo\models\Shg::getTableSchema()->fullName . '.block_code' => $this->block_code,
            \cbo\models\Shg::getTableSchema()->fullName . '.gram_panchayat_code' => $this->gram_panchayat_code,
        ]);
