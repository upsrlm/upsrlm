 ...
 * @property int $status
 */
class MasterVillage extends \common\models\dynamicdb\cbo_detail\CboDetailactiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['division_code', 'district_code', 'sub_district_code', 'village_code', 'gram_panchayat_code', 'block_code', 'status'], 'integer'],
