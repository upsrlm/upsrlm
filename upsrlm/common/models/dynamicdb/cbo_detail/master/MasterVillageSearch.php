...
use common\models\dynamicdb\cbo_detail\master\MasterVillage;
        ...
        if ($user_model == NULL) {
            ...
            if ($distinct_column != null) {
                ...
                if ($distinct_column == static::$coll_village) {
                    ...
                    $query->select(MasterVillage::getTableSchema()->fullName . '.village_code,master_village.village_name');
                    $query->distinct();
