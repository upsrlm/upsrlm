 ...
 */
class ShgMember extends \yii\base\Model {
    ...
    public function rules() {
        return [
            ...
            [['mcp_status'], 'required', 'when' => function ($model) {
                    if ($model->loan == 0) {
                        $cond = true;
                    } else {
                        $cond = false;
            ...
            [['loan_count', 'loan_amount', 'loan_date'], 'required', 'when' => function ($model) {
                    if ($model->loan == 1) {
                        $cond = true;
                    } else {
                        $cond = false;
