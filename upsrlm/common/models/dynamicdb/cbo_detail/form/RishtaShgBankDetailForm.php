...
class RishtaShgBankDetailForm extends \yii\base\Model {
    ...
    public function rules() {
        return [
            ...
            }, 'targetClass' => RishtaShgBankDetail::className(), 'message' => 'This Account Number has already been taken','targetAttribute'=>['bank_account_no_of_the_shg','status']],
