...
/**
 * DbtSchemeMgnreaFeedbackFormis the model behind the DbtSchemeMgnregaFeedback
 * @author Habibur Rahman <rahman.kld@gmail.com>
 */
class DbtSchemeMgnreaFeedbackForm extends \yii\base\Model {
    ...
    public function __construct($user_id) {
        ...
        $this->feedback_model = DbtSchemeMgnregaFeedback::findOne(['user_id' => $this->user_id]);
        ...
        if ($this->feedback_model == null) {
            $this->feedback_model = new DbtSchemeMgnregaFeedback();
