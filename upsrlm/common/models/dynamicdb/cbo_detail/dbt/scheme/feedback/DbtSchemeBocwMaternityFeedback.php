...
/**
 * This is the model class for table "dbt_scheme_bocw_maternity_feedback".
 *
 * @property int $id
 ...
 * @property int $status
 */
class DbtSchemeBocwMaternityFeedback extends CboDetailactiveRecord {
    /**
     * {@inheritdoc}
     */
    public static function tableName()
    {
        return 'dbt_scheme_bocw_maternity_feedback';
    }
