...
/**
 * This is the model class for table "dbt_scheme_bocw_construction_feedback".
 *
 * @property int $id
 ...
 * @property int $status
 */
class DbtSchemeBocwConstructionFeedback extends CboDetailactiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'dbt_scheme_bocw_construction_feedback';
    }
