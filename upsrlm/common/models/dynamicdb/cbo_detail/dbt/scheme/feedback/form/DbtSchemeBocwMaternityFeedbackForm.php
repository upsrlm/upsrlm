...
/**
 * DbtSchemeBocwMaternityFeedbackForm the model behind the DbtSchemeBocwMaternityFeedback
 * @author Habibur Rahman <rahman.kld@gmail.com>
 */
class DbtSchemeBocwMaternityFeedbackForm extends \yii\base\Model {
    ...
    public function __construct($user_id) {
        ...
        $this->feedback_model = DbtSchemeBocwMaternityFeedback::findOne(['user_id' => $this->user_id]);
        ...
        if ($this->feedback_model == null) {
            $this->feedback_model = new DbtSchemeBocwMaternityFeedback();
