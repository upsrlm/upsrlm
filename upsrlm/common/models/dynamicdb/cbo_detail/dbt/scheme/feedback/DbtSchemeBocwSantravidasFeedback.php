...
/**
 * This is the model class for table "dbt_scheme_bocw_santravidas_feedback".
 *
 * @property int $id
 ...
 * @property int $status
 */
class DbtSchemeBocwSantravidasFeedback extends CboDetailactiveRecord {
    /**
     * {@inheritdoc}
     */
    public static function tableName()
    {
        return 'dbt_scheme_bocw_santravidas_feedback';
    }
