...
// 	
/**
 * This is the model class for table "dbt_beneficiary_scheme_bocw_labour_scheme_status".
 *
 * @property int $id
 ...
 * @property int $status
 */
class DbtBeneficiarySchemeBocwLabourSchemeStatus extends CboDetailactiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'dbt_beneficiary_scheme_bocw_labour_scheme_status';
    }
    ...
    public function rules() {
        return [
            [['uplmis_gram_panchayat_code', 'scheme_id', 'division_code', 'district_code', 'block_code', 'gram_panchayat_code', 'created_at', 'updated_at', 'status', 'dbt_beneficiary_scheme_bocw_labour_profile_id'], 'integer'],
            [['app_date', 'dob'], 'safe'],
    ...
    public function afterSave($insert, $changedAttributes) {
        try {
            $model = new dbtBeneficiarySchemeBocwLabourSchemeStatusHistory();
