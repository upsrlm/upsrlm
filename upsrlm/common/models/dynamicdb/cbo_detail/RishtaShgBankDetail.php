 ...
 * @property int $status
 */
class RishtaShgBankDetail extends CboDetailactiveRecord {
    ...
    public function getBank() {
        return $this->hasOne(master\CboMasterBank::className(), ['id' => 'bank_id']);
    }

    public function getPassbook_photo_url() {

        return Yii::$app->params['app_url']['hr'] . "/getimage/cbo/shg/" . $this->cbo_shg_id . "/" . $this->passbook_photo;
    }
