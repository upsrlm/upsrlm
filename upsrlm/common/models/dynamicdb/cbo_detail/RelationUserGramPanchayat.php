 ...
 * @property int $status
 */
class RelationUserGramPanchayat extends CboDetailactiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['gram_panchayat_code'], 'string', 'max' => 6],
    ...
    public function beforeSave($insert) {
        if (isset($this->gram_panchayat_code) and $this->gram_panchayat_code) {
            $model = \app\models\master\MasterGramPanchayat::findOne(['gram_panchayat_code' => $this->gram_panchayat_code]);
            if ($model != NULL) {
