...
use Yii;
use common\models\dynamicdb\cbo\CboactiveRecord;
 ...
 * @property int $status
 */
class MopupSmsLog extends \common\models\dynamicdb\cbo\CboactiveRecord {
    ...
    public function rules() {
        return [
            [['user_id', 'sms_template_id', 'try_send_count', 'unicode', 'sms_length', 'sms_count', 'sms_provider_campaign_id', 'sms_provider_code', 'created_by', 'updated_by', 'updated_at', 'created_at', 'status', 'role'], 'integer'],
    ...
    public function getTemplate() {
        $a = [21 => 'MoPUP-PIN', 22 => 'MoPUP app with pin'];
        return isset($a[$this->sms_template_id]) ? $a[$this->sms_template_id] : '';
    }
