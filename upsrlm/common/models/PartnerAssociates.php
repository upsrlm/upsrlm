 ...
 *
 * @property int $id
 * @property int|null $master_bank_id
 ...
 * @property int $status
 */
class PartnerAssociates extends \common\models\dynamicdb\cbo\CboactiveRecord {
    ...
    public function rules() {
        return [
            [['master_bank_id', 'gender', 'age', 'created_by', 'created_at', 'updated_by', 'updated_at', 'status'], 'integer'],
            [['date_of_birth'], 'safe'],
    ...
    public function getDisblock() {
        return $this->hasMany(PartnerAssociatesBlock::className(), ['partner_associates_id' => 'id']);
    }
