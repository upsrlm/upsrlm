...
use common\models\GramPradhanVoiceSms;

/**
 * GramPradhanVoiceSmsSearch represents the model behind the search form of `common\models\GramPradhanVoiceSms`.
 */
class GramPradhanVoiceSmsSearch extends GramPradhanVoiceSms {
    ...
    public function search($params, $user_model = null, $pagination = true, $distinct_column = null) {
        ...
        $query = GramPradhanVoiceSms::find();
        $query->joinWith(['user']);
