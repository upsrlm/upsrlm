...
/**
 * SMMU_ProfileForm is the model behind the UserProfile
 * @author Habibur Rahman <rahman.kld@gmail.com>
 */
class SMMU_ProfileForm extends Model {
    ...
    public function rules() {
        return [
            ...
            [['present_address_house_no'], 'required'],
            [['permanent_address_street_mohalla'], 'required'],
            [['permanent_address_postoffice'], 'required'],
            [['permanent_address_district'], 'required'],
            [['permanent_address_state'], 'required'],
            [['present_address_house_no'], 'required'],
            [['present_address_street_mohalla'], 'required'],
            [['present_address_postoffice'], 'required'],
            ...
            [['brief_professional_profile', 'academic_qualification_awards', 'professional_training', 'experience', 'professional_association'], 'required'],
