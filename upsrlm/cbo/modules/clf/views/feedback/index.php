...
<div class="row">
                            ...
                            [
                                ...
                                'buttons' => [
                                    'view' => function ($url, $model) {
                                        return ' ' . Html::a('<span class="fal fa-eye"></span>', ['/clf/feedback/view?feedbackid=' . $model->id], [
                                            'data-pjax' => "0",
    ...
    $('form select').on('change', function(){
     $("#Searchform").attr({ "action":"/clf/feedback"});
...
JS;
        ...
        $(document).ready(function(){
            $("#download").click(function(event){
              $("#Searchform").attr({ "action":"/clf/feedback/downloadcsv"});
