...
<div class="row">
    ...
    echo $form->field($model, 'ques_8')->label('क्या मोबाइल ऐप के लिए कोई शुल्क निर्धारित होना चाहिए')->widget(Select2::classname(), [
        'data' => [1 => 'हाँ', 2 => 'नहीं '],
        'options' => ['placeholder' => 'क्या मोबाइल ऐप के लिए कोई शुल्क निर्धारित होना चाहिए', 'style' => 'width:250px'],
        'pluginOptions' => [
            'allowClear' => true
        ],
    ]);
    ...
    <?=Html::button('<i class="fal fa-download-alt"></i> Download Feedback CSV', ['class' => 'btn btn-primary btn-sm md-mt-2', 'style' => 'padding:7px 20px;margin-left:10px', 'id' => 'download', 'name' => 'download', 'value' => 'download']) ?>
    </div>
</div>
