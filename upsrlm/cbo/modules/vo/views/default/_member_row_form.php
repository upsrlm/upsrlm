...
echo '</td>';
echo '<td>';
echo "<div class='form-group field-cbovomembersform-$i-name'>";
echo "<div>";
...
echo '</td>';
echo '<td>';
echo "<div class='form-group field-cbovomembersform-$i-mobile_no'>";
echo "<div>";
...
echo '</td>';
echo '<td>';
echo "<div class='form-group field-cbovomembersform-$i-role'>";
echo "<div>";
...
echo '</td>';
echo '<td>';
echo "<div class='form-group field-cbovomembersform-$i-bank_operator''>";
echo "<div>";
