...
use common\models\dynamicdb\cbo_detail\RishtaShgFeedbackSearch;
    ...
    public function actionDownloadcsv() {
        try {
            ...
            foreach ($models as $model) {
                $row = [
                    $sr_no,
                    $model->cboshg != null ? $model->cboshg->name_of_shg : '',
                    $model->cboshg != null ? $model->cboshg->district_name : '',
                    $model->cboshg != null ? $model->cboshg->block_name : '',
                    $model->cboshg != null ? $model->cboshg->gram_panchayat_name : '',
                    $model->ques1,
                    $model->ques_2,
                    $model->ques_3,
                    $model->ques_4,
                    ...
                    $model->ques_7,
                    $model->ques8,
                    isset($model->entryby) ? $model->entryby->name . " (" . $model->entryby->mobile_no . ")" : ''
                ];
                fputcsv($output, $row);
                $sr_no++;
            }
