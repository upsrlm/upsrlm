...
//                        'contentOptions' => ['style' => 'width: 10%'],
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    $html .= yii\helpers\Html::button('<i class="fal fa-eye"></i> View BC GP SHG', ['id' => 'take-verify-' . $model->participant->id, 'class' => 'btn btn-sm btn-warning btn-block popb', 'value' => '/bc/certified/shg?gram_panchayat_code=' . $model->gram_panchayat_code, 'name' => 'takeaction', 'title' => 'BC GP : ' . $model->gram_panchayat_name . ' SHG']);
