...
<div class='profile-form' style="padding:0px 10px;background-color: white">
    ...
    <div class="row">
        ...
        <div class="col-md-8" style="text-align: left;font-size:16px;">
            ...
            2. BMM एवं मैनपावर मैनेजमेंट एजेंसी के द्वारा हस्ताक्षरित 'सर्विस एग्रीमेंट', एवं  <br/>
            3. अद्यतन 'पोस्टिंग आर्डर' की स्कैन्ड प्रति  (जिन BMM के सर्विस एग्रीमेंट के बाद कोई और पोस्टिंग नहीं हुआ, वे अपना सर्विस एग्रीमेंट की प्रति दोबारा अपलोड कर दें - इसे खाली न छोड़े I)   <br/>
                ...
                <div class="col-md-6">
                    ...
                    echo $form->field($model, 'posting_block_code')->widget(DepDrop::classname(), [
                        ...
                        'pluginOptions' => [
                            ...
                            'depends' => ['userprofileform-posting_district_code'],
