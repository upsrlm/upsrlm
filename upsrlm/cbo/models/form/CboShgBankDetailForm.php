 ...
 */
class CboShgBankDetailForm extends \yii\base\Model {
...
//            $this->passbook_photo = $this->shg_model->passbook_photo;
    ...
    public function rules() {
        return [
            [['bank_account_no_of_the_shg', 'bank_id', 'branch', 'branch_code_or_ifsc'], 'required'],
            ...
            [['passbook_photo'], 'required', 'on' => ['admin']],
    ...
    public function save() {
        ...
        $this->shg_model->bank_detail_by = \Yii::$app->user->identity->id;
        $this->shg_model->bank_detail_date = new \yii\db\Expression('NOW()');
        $this->shg_model->shg_bank = 1;
