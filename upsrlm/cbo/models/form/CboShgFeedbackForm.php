...
use Yii;
use cbo\models\Shg;
use cbo\models\CboShgFeedback;
use yii\web\UploadedFile;
use common\models\base\GenralModel;

/**
 * CboShgFeedbackForm is the model behind the CboShgFeedback
 * @author Habibur Rahman <rahman.kld@gmail.com>
 */
class CboShgFeedbackForm extends \yii\base\Model {
    ...
    public function __construct($shg_model) {
        ...
        $this->shg_feedback_model = CboShgFeedback::findOne(['cbo_shg_id' => $this->shg_model->id]);
        ...
        if ($this->shg_feedback_model == null) {
            $this->shg_feedback_model = new CboShgFeedback();
