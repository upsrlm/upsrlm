...
/**
 * CboClfFeedbacknextform is the model behind the CboClfFeedback
 * @author Habibur Rahman <rahman.kld@gmail.com>
 */
class CboClfFeedbacknextform extends \yii\base\Model {
    ...
    public $t9ques = ['ques_91', 'ques_92', 'ques_93', 'ques_94', 'ques_95', 'ques_96', 'ques_97', 'ques_98', 'ques_99'];
    public $p9ques = [];
    public $other9ques = [];
    ...
    public function __construct($clf_model) {
        ...
        if ($this->clf_feedback_model == null) {
            ...
            if ($this->clf_feedback_model->ques_91 == 2) {
                array_push($this->p9ques, 'ques_91');
            }
            if ($this->clf_feedback_model->ques_92 == 2) {
                array_push($this->p9ques, 'ques_92');
            }
            if ($this->clf_feedback_model->ques_93 == 2) {
                array_push($this->p9ques, 'ques_93');
            }
            if ($this->clf_feedback_model->ques_94 == 2) {
                array_push($this->p9ques, 'ques_94');
            }
            if ($this->clf_feedback_model->ques_95 == 2) {
                array_push($this->p9ques, 'ques_95');
            }
            if ($this->clf_feedback_model->ques_96 == 2) {
                array_push($this->p9ques, 'ques_96');
            }
            if ($this->clf_feedback_model->ques_97 == 2) {
                array_push($this->p9ques, 'ques_97');
            }
            if ($this->clf_feedback_model->ques_98 == 2) {
                array_push($this->p9ques, 'ques_98');
            }
            if ($this->clf_feedback_model->ques_99 == 2) {
                array_push($this->p9ques, 'ques_99');
            }
            $this->other9ques = array_diff($this->t9ques, $this->p9ques);
    ...
    public function rules() {
        return [
            [['cbo_clf_id'], 'required'],
            [['ques_10'], 'required', 'message' => 'आवश्यक है'],
            ...
            ['ques_91a', 'required', 'when' => function ($model) {
                    return $model->ques_91 > '0';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_91').val() > '0';
            }"],
            ['ques_92a', 'required', 'when' => function ($model) {
                    return $model->ques_92 > '0';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_92').val() > '0';
            }"],
            ['ques_93a', 'required', 'when' => function ($model) {
                    return $model->ques_93 > '0';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_93').val() > '0';
            }"],
            ['ques_94a', 'required', 'when' => function ($model) {
                    return $model->ques_94 > '0';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_94').val() > '0';
            }"],
            ['ques_95a', 'required', 'when' => function ($model) {
                    return $model->ques_95 > '0';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_95').val() > '0';
            }"],
            ['ques_96a', 'required', 'when' => function ($model) {
                    return $model->ques_96 > '0';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_96').val() > '0';
            }"],
            ['ques_97a', 'required', 'when' => function ($model) {
                    return $model->ques_97 > '0';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_97').val() > '0';
            }"],
            ['ques_98a', 'required', 'when' => function ($model) {
                    return $model->ques_98 > '0';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_98').val() > '0';
            }"],
            ['ques_99a', 'required', 'when' => function ($model) {
                    return $model->ques_99 > '0';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                 return $('#ques_99').val() > '0';
            }"],
            ['ques_91', 'required', 'when' => function ($model) {
                    return $model->ques_91a != '';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_91a').val() !== '';
            }"],
            ['ques_92', 'required', 'when' => function ($model) {
                    return $model->ques_92a != '';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_92a').val() !== '';
            }"],
            ['ques_93', 'required', 'when' => function ($model) {
                    return $model->ques_93a != '';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_93a').val() !== '';
            }"],
            ['ques_94', 'required', 'when' => function ($model) {
                    return $model->ques_94a != '';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_94a').val() !== '';
            }"],
            ['ques_95', 'required', 'when' => function ($model) {
                    return $model->ques_95a != '';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_95a').val() !== '';
            }"],
            ['ques_96', 'required', 'when' => function ($model) {
                    return $model->ques_96a != '';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_96a').val() !== '';
            }"],
            ['ques_97', 'required', 'when' => function ($model) {
                    return $model->ques_97a != '';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_97a').val() !== '';
            }"],
            ['ques_98', 'required', 'when' => function ($model) {
                    return $model->ques_98a != '';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                  return $('#ques_98a').val() !== '';
            }"],
            ['ques_99', 'required', 'when' => function ($model) {
                    return $model->ques_99a != '';
                }, 'message' => 'आवश्यक है', 'whenClient' => "function (attribute, value) {
                 return $('#ques_99a').val() !== '';
            }"],            
    ...
    public function attributeLabels() {
        return [
            ...
            'ques_9a' => '9. प्रमुख 3 सुविधा',
            'ques_9b' => '9. अन्य सुविधाएँ',
            'ques_91' => '9.1. मोबाइल ऐप पर ही इसके संचालन के लिए उपयुक्त दिशा-निर्देश/ गाइडलाइन मिले ।',
            'ques_92' => '9.2. राज्य मिशन से मिलने वाली सभी सुविधाओं की सूचना सरल हिंदी में मोबाइल ऐप पर ही प्राप्त हो ।',
    ...
    public function save() {
        try {
            ...
            $this->clf_feedback_model->ques_91a = $this->ques_91a;
            $this->clf_feedback_model->ques_92a = $this->ques_92a;
            $this->clf_feedback_model->ques_93a = $this->ques_93a;
            $this->clf_feedback_model->ques_94a = $this->ques_94a;
            $this->clf_feedback_model->ques_95a = $this->ques_95a;
            $this->clf_feedback_model->ques_96a = $this->ques_96a;
            $this->clf_feedback_model->ques_97a = $this->ques_97a;
            $this->clf_feedback_model->ques_98a = $this->ques_98a;
            $this->clf_feedback_model->ques_99a = $this->ques_99a;
