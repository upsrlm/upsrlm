...
/**
 * PostController implements the CRUD actions for CboVo model.
 */
class PostController extends Controller
{
    ...
    /**
     * Deletes an existing CboVo model.
