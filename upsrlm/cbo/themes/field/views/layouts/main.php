    ...
    <body class="no-skin" ng-app="questionnaireApp">
        ...
        <div class="top-head">
            ...
            <div class="row">  
                ...
                <div class="col-lg-2">
                    <h2 style="color: #F79520;"> C.B.O Portal</h2>
                </div>
                <div class="col-lg-4">
                                ...
                                <li class="blue">
                                    ...
                                    <li class="blue">  
                                        <a  data-toggle="dropdown" class="dropdown-toggle "  href="#">
                                            <i class="mdi mdi-view-list"></i> <span>SHG</span> 
                                        ...
                                        <ul class="user-menu dropdown-menu-right dropdown-navbar navbar-grey dropdown-menu dropdown-caret dropdown-close">
                                            <li class="dropdown-header">
                                                <a href="/shg" style="padding-left: 10px;"> <i class="ace-icon fa fa-copy" style="color: #2b7dbc;"></i><span style="color: #2b7dbc;">List</span> </a>
                                            </li>
                                            <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_BMMU]))) { ?>
                                                ...
                                                <li class="dropdown-header">
                                                    <a href="/shg/default/create" style="padding-left: 10px;"><i class="fa fa-dashboard"></i><span> Add </span> </a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    </li>
                                    <li class="blue">  
                                        <a  data-toggle="dropdown" class="dropdown-toggle "  href="#">
                                            <i class="mdi mdi-view-list"></i> <span>VO</span> 
                                            <i class="ace-icon fa fa-caret-down"></i>
                                        </a>
                                        <ul class="user-menu dropdown-menu-right dropdown-navbar navbar-grey dropdown-menu dropdown-caret dropdown-close">
                                            <li class="dropdown-header">
                                                <a href="/vo" style="padding-left: 10px;"> <i class="ace-icon fa fa-copy" style="color: #2b7dbc;"></i><span style="color: #2b7dbc;">List</span> </a>
                                            </li>
                                            <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_BMMU]))) { ?>

                                                <li class="dropdown-header">
                                                    <a href="/vo/default/create" style="padding-left: 10px;"><i class="fa fa-dashboard"></i><span> Add </span> </a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    </li>
                                    <li class="blue">  
                                        <a  data-toggle="dropdown" class="dropdown-toggle "  href="#">
                                            <i class="mdi mdi-view-list"></i> <span>CLF</span> 
                                            <i class="ace-icon fa fa-caret-down"></i>
                                        </a>
                                        <ul class="user-menu dropdown-menu-right dropdown-navbar navbar-grey dropdown-menu dropdown-caret dropdown-close">
                                            <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN]))) { ?>
                                                ...
                                                <li class="dropdown-header">
                                                    <a href="/clf/dashboard" style="padding-left: 10px;"><i class="fa fa-dashboard"></i><span> Dashboard </span> </a>
                                                </li>
                                            <?php } ?>
                                            <li class="dropdown-header">
                                                <a href="/clf" style="padding-left: 10px;"> <i class="ace-icon fa fa-copy" style="color: #2b7dbc;"></i><span style="color: #2b7dbc;">List</span> </a>
                                            </li>
                                            <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_BMMU]))) { ?>

                                                <li class="dropdown-header">
                                                    <a href="/clf/default/create" style="padding-left: 10px;"><i class="fa fa-dashboard"></i><span> Add </span> </a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    </li>
                                    <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPER_ADMIN, MasterRole::ROLE_BMMU]))) { ?>
                                        <li class="blue">  
                                            ...
                                            <ul class="user-menu dropdown-menu-right dropdown-navbar navbar-grey dropdown-menu dropdown-caret dropdown-close">
                                                <li class="dropdown-header">
                                                    <a href="/bc/noshg" style="padding-left: 10px;"><i class="fa fa-user"></i><span> List (No SHG) </span> </a>
                                                </li>
                                    ...
                                    <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_MD, MasterRole::ROLE_SUPER_ADMIN]))) { ?>
                                        <li class="blue">  
                                            ...
                                            <ul class="user-menu dropdown-menu-right dropdown-navbar navbar-grey dropdown-menu dropdown-caret dropdown-close">
                                                <li class="dropdown-header">
                                                    <a href="/shg/report/registration" style="padding-left: 10px;"> <i class="ace-icon fa fa-copy" style="color: #2b7dbc;"></i><span style="color: #2b7dbc;">CBO Registration</span> </a>
                                                </li>
                                                <li class="dropdown-header">
                                                    <a href="/shg/report/daily" style="padding-left: 10px;"> <i class="ace-icon fa fa-download" style="color: #2b7dbc;"></i><span style="color: #2b7dbc;">Daily Activity SHG BMMU </span> </a>
                                                </li>
                                                 <li class="dropdown-header">
                                                    <a href="/shg/report/dailyv" style="padding-left: 10px;"> <i class="ace-icon fa fa-download" style="color: #2b7dbc;"></i><span style="color: #2b7dbc;">Daily Activity SHG Verifier</span> </a>
                                                </li>
                                             <?php if (!Yii::$app->user->isGuest && (in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN,MasterRole::ROLE_SUPER_ADMIN]))) { ?>   
                                                <li class="dropdown-header">
                                                    <a href="/shg/report/csvshgreggp" style="padding-left: 10px;"> <i class="ace-icon fa fa-download" style="color: #2b7dbc;"></i><span style="color: #2b7dbc;">CBO SHG Registration</span> </a>
                                                </li>
                                                <?php } ?>
                                            </ul>
                                        </li>
