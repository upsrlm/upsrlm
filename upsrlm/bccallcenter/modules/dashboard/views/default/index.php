                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    return Html::a($model->participant->name, '#', ['value' => '/dashboard/default/view?participantid=' . $model->id, 'data-pjax' => "0", 'title' => $model->participant->name, 'class' => 'popb']) . $html;
                                }
                            ],
                            [
                                'attribute' => 'mobile_no',
...
//                        'contentOptions' => ['style' => 'width: 10%'],
                            ...
                            [
                                ...
                                'format' => 'raw',
                                'value' => function ($model) {
                                    return isset($model->participant->bank_account_no_of_the_bc) ? 'Yes' : 'No';
                                }
                            ],
                            [
                                'attribute' => 'bc_bank',
                                ...
                                'value' => function ($model) {
                                    ...
                                    return Html::a($model->participant->bcbanks, '#', ['value' => '/dashboard/default/bankstatus?bcid=' . $model->participant->id, 'data-pjax' => "0", 'title' => $model->participant->name, 'class' => 'popb']);
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    return ($model->participant->bank_account_no_of_the_shg != null) ? 'Yes' : 'No';
                                }
                            ],
                            [
                                'attribute' => 'shg_bank',
                                ...
                                'value' => function ($model) {
                                    $arr = [0 => 'बैंक विवरण अपलोड नहीं ', 1 => 'बैंक विवरण अपलोड किया गया', 2 => 'बैंक विवरण सत्यापित', 3 => 'बैंक विवरण वापसी'];
                                    return Html::a($model->participant->shgbanks, '#', ['value' => '/dashboard/default/bankstatus?bcid=' . $model->participant->id, 'data-pjax' => "0", 'title' => $model->participant->name, 'class' => 'popb']);
                            ...
                            [
                                ...
                                'format' => 'raw',
                                'value' => function ($model) {
                                    return $model->participant->bc_photo_status == 1 ? 'Yes' : 'No';
                                }
                            ],
                            [
                                'attribute' => 'pin',
                                ...
                                'format' => 'raw',
                                'value' => function ($model) {
                                    return (isset($model->participant->user->pin) and $model->participant->blocked == '0') ? $model->participant->user->pin : '';
                                }
                            ],
                            [
                                'attribute' => 'pin',
                                ...
                                'format' => 'raw',
                                'value' => function ($model) {
                                    return (isset($model->participant) and $model->participant->pin_used == 1) ? 'Yes' : 'No';
                                }
                            ],
//                            [
//                                'attribute' => 'Action',
...
//
//                                    $html .= yii\helpers\Html::button('<i class="fas fa-thumb-up"></i> View BC GP SHG', ['id' => 'take-verify-' . $model->participant->id, 'class' => 'btn btn-sm btn-warning btn-block popb', 'value' => '/bc/default/shg?gram_panchayat_code=' . $model->gram_panchayat_code, 'name' => 'takeaction', 'title' => 'BC GP : ' . $model->gram_panchayat_name . ' SHG']);
//
//                                    $html .= "</span>";
//
//                                    return $html;
...
//                            ],
                            [
                                ...
                                'value' => function ($model) {
                                    $html = '';
                                    $html .= \yii\helpers\Html::a('<i class="fal fa-phone"></i> कॉल करें', ['/platform/call/scenario?bcid=' . $model->bc_application_id . ''], ['data-toggle' => "tooltip", 'data-pjax' => 0, 'class' => 'btn btn-info']);

                                    return $model->participant->callaction;
                                }
                            ],
                        ],
                    ]);
