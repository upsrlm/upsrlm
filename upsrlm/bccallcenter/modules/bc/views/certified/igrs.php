        ...
        <div id="panel-1" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <?php echo $this->render('_searchigrs', ['model' => $searchModel]); ?>
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    return Html::a($model->participant->name, '#', ['value' => '/bc/certified/view?participantid=' . $model->id, 'data-pjax' => "0", 'title' => $model->participant->name, 'class' => 'popb']) . $html;
                                }
                            ],
                            [
                                'attribute' => 'mobile_no',
...
//                        'contentOptions' => ['style' => 'width: 10%'],
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    return Html::a($model->participant->bcbanks, '#', ['value' => '/bc/certified/bankstatus?bcid=' . $model->participant->id, 'data-pjax' => "0", 'title' => $model->participant->name, 'class' => 'popb']);
...
cs;
        ...
        $("#downloadbcs").click(function(event){
         ...
         $("#searchbtn").click(function(event){
                $("#Searchform").attr({ "action":"/bc/certified/igrs"});
