...
//                        'contentOptions' => ['style' => 'width: 10%'],
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    $models= SrlmBcApplication::findOne($model->id);
                                    return $models->callaction;
                                }
                            ],
                        ],
                    ]);
...
cs;
        ...
        $("#downloadbcs").click(function(event){
              $("#Searchform").attr({ "action":"/bc/register/csvdownload"});
              $("#Searchform").removeAttr("data-pjax");
              $("#Searchform").submit();
            });         
         $("#searchbtn").click(function(event){
                $("#Searchform").attr({ "action":"/bc/register"});
