                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    return isset($model->bc) ? Html::a($model->bc->name, "/report/tracking/bc/dailyperformance?BcTransactionBcSummaryDailySearch[bc_application_id]=" . $model->bc->id, ['target' => '_blank', 'data-pjax' => "0"]) : '';
...
js;
    ...
    $("#Searchform").attr({ "action":"/report/tracking/bc/overallperformance"});
    $("#Searchform").attr("data-pjax", "True");                
