        ...
        foreach ($dataProvider->getModels() as $model) {
            ...
            <tr>
                ...
                <td class="text-center"><?= $model->certified_bc ?></td>
                 <td colspan="1" class="text-center bg-warning-50"><?= ($model->no_of_bc_shortlisted - ($model->urban + $model->no_of_bc_registered + $model->agree + $model->blocked_bc)) ?></td>
