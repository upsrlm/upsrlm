...
$this->title = 'BC Selection : Pre Selected';
...
//                                'contentOptions' => ['style' => 'width:7%'],
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    ...
                                    $html .= $model->aadhar_front_photo != null ? '<span class="profile-picture">
                                        <img width="150px" height="150px"  data-src="' . Yii::$app->params['app_url']['bc'] . $model->aadhar_front_photo_url . '"  class="lozad" title="aadhar_front_photo" style="cursor : pointer"/>
                                        </span> ' : '';
                                    $html .= $model->aadhar_back_photo != null ? '<span class="profile-picture">
                                        <img width="150px" height="150px" data-src="' . Yii::$app->params['app_url']['bc'] . $model->aadhar_back_photo_url . '"  class="lozad" title="aadhar_back_photo" style="cursor : pointer"/>
                                        </span> ' : '';
        ...
        $(document).ready(function(){
            $("#download").click(function(event){
              $("#Searchform").attr({ "action":"/training/preselected/downloadcsv"});
              $("#Searchform").removeAttr("data-pjax");
              $("#Searchform").submit();
            });
                 
        $("#searchbtn").click(function(event){
                $("#Searchform").attr({ "action":"/training/preselected"});
