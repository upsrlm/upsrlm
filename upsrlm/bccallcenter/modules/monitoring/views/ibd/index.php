...
<?= $this->render('_search', ['model' => $searchModel, 'user_model' => $user_model]); ?>

<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>Calling Agent Daily IBD Progress</h2>
            </div>
                ...
                <div class="panel-content">
                    ...
                    \kartik\grid\GridView::widget([
                        ...
                        'columns' => [
                            ...
                            'agentdetail.urole.role_name:raw:Group',
                            [
                                'header' => 'Call Date',
                                'enableSorting' => false,
                            ...
                            [
                                ...
                                'value' => function ($model) use ($searchModel) {
                                    ...
                                    return \yii\helpers\Html::a($model->ibd_call, [
                                        '/monitoring/ibd/calldetail',
                                        'CallingAgentProgressIbdSearch[calling_agent_id]' => $model->calling_agent_id,
                                        'CallingAgentProgressIbdSearch[calling_agent_role]' => $model->calling_agent_role,
                                        'CallingAgentProgressIbdSearch[calling_date]' => $model->calling_date
                                            ], [
                                        'target' => '_blank',
                                        'title' => 'View Call Detail',
                                        'data-pjax' => "0"
                                    ]);
                                    return $model->ibd_call;
                                },
                                'format' => 'raw'
                            ],
                            [
                                'attribute' => 'other_call',
                                'label' => 'Unregistered Call',
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return $model->other_call;
                                }
                            ],
                            [
                                'attribute' => 'registred_call',
                                'enableSorting' => false,
                                'value' => function ($model) {
                                    return $model->registred_call;
                                }
                            ],
                            [
