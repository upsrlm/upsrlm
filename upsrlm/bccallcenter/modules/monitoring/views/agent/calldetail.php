...
<?php // $this->render('_progress_search', ['model' => $searchModel]); 
?>
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    if ($model->recording_file) {
                                        return $model->recording_file != null ? \yii\helpers\Html::button('<span class="fal fa-file-audio">Audio</span>', [
                                            'data-pjax' => "0",
                                            'class' => 'btn btn-block btn-danger popb',
                                            'value' => '/platform/log/telecalleraudio?log_id=' . $model->id. '&date=' . date('Y-m-d', $model->created_at),
                                            'title' => 'Audio'
                                        ]) . ' ' : '';
                                    }else{
                                        return '';
