...
//                        'floatHeaderOptions' => ['scrollingTop' => '50'],
                        'columns' => [
                            ...
                            [
                                ...
                                'header' => 'Feedback',
                                'value' => function ($model) {
                                    return $model->feedback != null ? 'Yes' : 'No';
                                },
                            ],
                            [
                            ...
                            [
                                'attribute' => 'Action',
                                'format' => 'raw',
                                'visible' =>0,// isset(Yii::$app->user->identity) and in_array(Yii::$app->user->identity->role, [MasterRole::ROLE_ADMIN, MasterRole::ROLE_SUPPORT_UNIT]),
                                'value' => function ($model) {

                                    $html = '<span id="' . $model->id . '">';

                                    $html .= yii\helpers\Html::button('<i class="fa fa-thumb-up"></i> Create CBO user', ['id' => 'take-verify-' . $model->id, 'class' => 'btn btn-sm btn-warning btn-block popb', 'value' => '/clf/default/member?clfid=' . $model->id, 'name' => 'takeaction', 'title' => 'CLF : ' . $model->name_of_clf . ' member']);
