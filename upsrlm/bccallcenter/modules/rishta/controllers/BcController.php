...
class BcController extends Controller {
    ...
    public function actionIndex() {
        ...
        if ($searchModel->blocked_bc != '') {
            if ($searchModel->blocked_bc == '0') {
                $dataProvider->query->andWhere(['srlm_bc_application.blocked' => $searchModel->blocked_bc]);
            }
            if ($searchModel->blocked_bc == '1') {
