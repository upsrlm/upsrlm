            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <?php if (isset($user->user->name)) { ?>
                        <?= $form->field($user, 'name')->textInput(['value' => $user->user->name, 'maxlength' => true, 'readonly' => 'readonly']) ?>
                        <?= $form->field($user, 'role')->textInput(['value' => $user->user->urole->role_name,'maxlength' => true, 'readonly' => 'readonly']) ?>
                        <?=
                    ...
                    <div class="form-group">
                        <?= $form->field($user, 'success')->hiddenInput()->label(false); ?>
